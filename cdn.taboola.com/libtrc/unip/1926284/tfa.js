...
function(e, t) {
    ...
    var n = function e() {
        ...
        i = function t(r, i, s, c, u) {
            var l, f = new(e.XDomainRequest || e.XMLHttpRequest);
            return f.open(r, i), f.onload = "function" == typeof c ? c : n, f.onerror = n, f.ontimeout = n, f.onprogress = n, f.withCredentials = !0, u && o(f, u), s && a(f, s), f
        },
        o = function e(t, n) {
...
function(e, t) {
    e._tfa = e._tfa || [], e._tfa.config || (e._tfa.TfaConfig = function() {
        this.configMap = {}, this.trackedElements = []
        ...
        addTrackedElements: function e(t) {
            this.trackedElements = t
        }
    }, e._tfa.config = new e._tfa.TfaConfig, e._taboola = e._taboola || []), e._tfa.config.addConfig(1926284, {
        "tfa:event-host-map": {
        ...
        "tfa:engagement:use-new-interval-calculation": true,
        "tfa:allow-codeless-tracking": true,
        "tfa:tfa-codeless-tracking:selector-matching-by-native-css": true,
        "tfa:tfa-codeless-tracking:advanced-matching": true,
        "tfa:codeless-domain-override": true
    }), e._tfa.config.addTrackedElements([])
}(window, window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC']),
function(e, t, n) {
    "use strict";
    var r = e[n.jsScope],
    ...
    var u = null,
        ...
        P = [_, R],
        U = [I, C, w],
        D = (($ = {})[r.publisherIdType.NAME] = "name", $[r.publisherIdType.ID] = "id", $),
        A = function() {
        ...
        F = B.UNINITIALIZED,
        G = (e.taboola_view_id || (e.taboola_view_id = (new Date).getTime()), e.taboola_view_id),
        K, $, H = function t() {
            var i = function e() {};
            ...
            }, i.prototype.parseConsent = function() {}, i.prototype.addListenerForConsentChange = function() {}, i.prototype.isCookieBannerOpen = function() {
                return !1
            }, i.prototype.version = "1";
            var o = function e() {};
            (o.prototype = Object.create(i.prototype)).constructor = o, o.prototype.providerName = "TcfApi", o.prototype.version = "2", o.prototype.isCookieBannerOfProvider = function() {
            ...
            var a = function e() {};
            (a.prototype = Object.create(i.prototype)).constructor = a, a.prototype.providerName = "OneTrust", a.prototype.isCookieBannerOfProvider = function() {
            ...
            var s = function e() {};
            (s.prototype = Object.create(i.prototype)).constructor = s, s.prototype.providerName = "Didomi", s.prototype.isCookieBannerOfProvider = function() {
            ...
            }, s.prototype.addListenerForConsentChange = function() {
                e.didomiEventListeners = window.didomiEventListeners || [], e.didomiEventListeners.push({
                    event: "consent.changed",
                    listener: function e(t) {
                        r.trk.parseCookieBannerConsent(s.prototype)
                    }
                })
            }, s.prototype.isCookieBannerOpen = function() {
                return void 0 !== e.Didomi.notice && void 0 !== e.Didomi.notice.isVisible && e.Didomi.notice.isVisible()
            };
            var c = function e() {};
            (c.prototype = Object.create(i.prototype)).constructor = c, c.prototype.providerName = "Usercentrics", c.prototype.isCookieBannerOfProvider = function() {
            ...
            var u = function e() {};
            (u.prototype = Object.create(i.prototype)).constructor = u, u.prototype.providerName = "Cookiebot", u.prototype.isCookieBannerOfProvider = function() {
                return void 0 !== e.Cookiebot
            }, u.prototype.parseConsent = function() {
                ...
                if ("function" == typeof window.addEventListener) {
                    var e = function e(t) {
                        r.trk.parseCookieBannerConsent(u.prototype)
                    };
                    window.addEventListener("CookiebotOnConsentReady", e)
                }
            };
            var l = function e() {};
            (l.prototype = Object.create(i.prototype)).constructor = l, l.prototype.providerName = "SourcePoint", l.prototype.isCookieBannerOfProvider = function() {
                return void 0 !== e._sp_
            }, l.prototype.addListenerForConsentChange = function() {
            ...
            var f = function e() {};
            (f.prototype = Object.create(i.prototype)).constructor = f, f.prototype.providerName = "ConsentManager", f.prototype.isCookieBannerOfProvider = function() {
                return void 0 !== e.cmpmngr && "function" == typeof e.__cmp
            }, f.prototype.parseConsent = function() {
                var t = e.__cmp("getCMPData");
                void 0 !== t && void 0 !== t.consentstring && "" !== t.consentstring ? q({
                    tcString: t.consentstring,
                    cmpStatus: 0
                }) : q(null)
            }, f.prototype.addListenerForConsentChange = function() {
                var t = function e() {
                    r.trk.parseCookieBannerConsent(f.prototype)
                };
                e.__cmp("addEventListener", ["consent", t, !1, null])
            };
            var d = function e() {};
            (d.prototype = Object.create(i.prototype)).constructor = d, d.prototype.providerName = "Shopify", d.prototype.isCookieBannerOfProvider = function() {
                return void 0 !== e.Shopify && void 0 !== e.Shopify.customerPrivacy
            }, d.prototype.parseConsent = function() {
                "function" == typeof e.Shopify.customerPrivacy.marketingAllowed ? q({
                    consentData: e.Shopify.customerPrivacy.marketingAllowed().toString()
                }) : q(null)
            }, d.prototype.addListenerForConsentChange = function() {
                if ("function" == typeof window.addEventListener) {
                    var e = function e(t) {
                        r.trk.parseCookieBannerConsent(d.prototype)
                    };
                    window.addEventListener("visitorConsentCollected", e)
                }
            };
            var p = function e() {};
            (p.prototype = Object.create(i.prototype)).constructor = p, p.prototype.providerName = "CookieYes", p.prototype.isCookieBannerOfProvider = function() {
                return "function" == typeof e.getCkyConsent
            }, p.prototype.parseConsent = function() {
                var t = null;
                try {
                    if (e.getCkyConsent && "function" == typeof e.getCkyConsent) {
                        var n = e.getCkyConsent();
                        if (n && n.categories && "object" === _typeof(n.categories)) {
                            var r = n.categories,
                                i;
                            t = {
                                consentData: (Object.keys(r).length > 0 && Object.keys(r).every(function(e) {
                                    return !0 === r[e]
                                })).toString()
                            }
                        }
            ...
            var h = function e() {};
            (h.prototype = Object.create(i.prototype)).constructor = h, h.prototype.providerName = "CookieFirst", h.prototype.isCookieBannerOfProvider = function() {
                return void 0 !== e.CookieFirst && void 0 !== e.CookieFirst.consent
            }, h.prototype.parseConsent = function() {
                var t = null;
                try {
                    if (e.CookieFirst && e.CookieFirst.consent && "object" === _typeof(e.CookieFirst.consent)) {
                        var n = e.CookieFirst.consent,
                            r;
                        t = {
                            consentData: (Object.keys(n).length > 0 && Object.keys(n).every(function(e) {
                                return !0 === n[e]
                            })).toString()
                        }
                    }
            ...
            var g = function e() {};
            (g.prototype = Object.create(i.prototype)).constructor = g, g.prototype.providerName = "Klaro", g.prototype.isCookieBannerOfProvider = function() {
                return void 0 !== e.klaroConfig || void 0 !== e.klaro
            }, g.prototype.parseConsent = function() {
                var t = null;
                try {
                    if (e.klaro && "function" == typeof e.klaro.getManager) {
                        var n = e.klaro.getManager();
                        if (n && n.consents && "object" === _typeof(n.consents)) {
                            var r = n.consents,
                                i;
                            t = {
                                consentData: (Object.keys(r).length > 0 && Object.keys(r).every(function(e) {
            ...
            var v = function e() {};
            (v.prototype = Object.create(i.prototype)).constructor = v, v.prototype.providerName = "CookieScript", v.prototype.isCookieBannerOfProvider = function() {
                return void 0 !== e.CookieScript
            }, v.prototype.parseConsent = function() {
                var t = null;
                try {
                    if (e.CookieScript && e.CookieScript.instance && "function" == typeof e.CookieScript.instance.currentState) {
                        var n = e.CookieScript.instance.currentState();
                        t = n && "accept" === n.action ? {
                            consentData: "true"
                        } : {
                            consentData: "false"
            ...
            var m = ["ad_storage"],
                y = function e() {};
            (y.prototype = Object.create(i.prototype)).constructor = y, y.prototype.providerName = "Gtm", y.prototype.isCookieBannerOfProvider = function() {
                return !!(e.dataLayer && "function" == typeof e.dataLayer.push || e.google_tag_data)
            }, y.prototype.parseConsent = function() {
                function t(e, t) {
                    return e ? "granted" : t ? "denied" : null
                }
                ...
                function i(e, n) {
                    for (var r = !0, i = !1, o = 0; o < n.length; o++) {
                        var a, s = e[n[o]],
                            c = s && s.update;
                        if (!1 === c) {
                            i = !0, r = !1;
                ...
                function a(e) {
                    for (var t = e.length - 1; t >= 0; t--) {
                        var n = e[t];
                        if (n && "consent" === n[0] && "update" === n[1] && n[2] && "object" === _typeof(n[2])) return n[2]
                    }
                    return null
                }
                try {
                    var s = e._tfa.config.safeGet("tfa:trk:gtm-consent-fields", m, n.bakedPublisherId),
                        c;
                    if (e.google_tag_data && e.google_tag_data.ics && e.google_tag_data.ics.entries && null !== (c = i(e.google_tag_data.ics.entries, s))) return void r(c);
                    if (e.dataLayer && e.dataLayer.length) {
                        var u = a(e.dataLayer);
                        if (u) return void r(c = o(u, s))
                    }
                } catch (e) {}
                q(null)
            }, y.prototype.addListenerForConsentChange = function() {
                var t = e._tfa.config.safeGet("tfa:trk:gtm-consent-fields", m, n.bakedPublisherId);
                e.google_tag_data && e.google_tag_data.ics && "function" == typeof e.google_tag_data.ics.addListener && e.google_tag_data.ics.addListener(t, function() {
                    r.trk.parseCookieBannerConsent(y.prototype)
                })
            };
            var S = function e() {};
            return S.COOKIE_NAME = "aep_usuc_f", S.CONSENT_FIELD = "ae_u_p_s", S.CONSENT_VALUE = "2", S.NON_CONSENT_VALUE = "1", (S.prototype = Object.create(i.prototype)).constructor = S, S.prototype.providerName = "AliExpress", S.prototype.isCookieBannerOfProvider = function() {
                return null !== Se(S.COOKIE_NAME)
            }, S.prototype.parseConsent = function() {
                var e = Se(S.COOKIE_NAME);
                if (e) {
                    for (var t = e.split("&"), n = 0; n < t.length; n++) {
                        var r = t[n].split("=");
                        if (r[0] === S.CONSENT_FIELD) {
                            var i = r[1];
                            return void q(i === S.CONSENT_VALUE ? {
                                consentData: "true"
                            } : i === S.NON_CONSENT_VALUE ? {
                                consentData: "false"
                            } : null)
                        }
                    }
                ...
                "OneTrust,V1": new a,
                "Didomi,V1": new s,
                "Usercentrics,V1": new c,
                "Cookiebot,V1": new u,
                "SourcePoint,V1": new l,
                "ConsentManager,V1": new f,
                "Shopify,V1": new d,
                "AliExpress,V1": new S,
                "CookieYes,V1": new p,
                "CookieFirst,V1": new h,
                "CookieScript,V1": new v,
                "Klaro,V1": new g,
                "GTMConsentMode,V1": new y
            }
        },
        q = function e(t) {
        ...
        Y = function e(t) {
            ...
            this.href = t;
            var n = J(t, "#", 2);
            return this.hash = n.length > 1 ? "#" + n.pop() : "", t = n[0], n = J(t, "?", 2), this.search = n.length > 1 ? "?" + n.pop() : "", t = n[0], n = J(t, "://", 2), this.protocol = n.length > 1 ? n.shift() + ":" : "", t = n[0], n = J(t, "/", 2), this.pathname = n.length > 1 ? "/" + n.pop() : "/", t = n[0], n = J(t, "@", 2), this.auth = n.length > 1 ? n.shift() : "", t = n[0], n = J(t, ":", 2), this.port = n.length > 1 ? parseInt(n.pop()) : 0, this.host = n[0], this
        },
        X = {
            "http:": 1,
            "https:": 1
    ...
    var Z = {
            ...
            getBlockedState: function e(t) {
                return ke() || Re() ? this.states.ABP_NOT_DETECTED : t && this.isBlockDetectedOnClassNames(t) ? this.states.ABP_DETECTED : this.states.ABP_NOT_DETECTED
            }
        },
        ee = function e(t, n) {
        ...
        ne = function t(n) {
            te(n), n[S] = _, n.isMediaRequest || (e.TRC.trkRequestStatus = !1), F === B.PENDING_USER_ID_SET && (F = B.UNINITIALIZED), n[b] ? r.eventUtils.dispatchEvent(r.sharedEvents.INVALID_TRK_RESPONSE, {
        ...
        ie = function e(t, n, r, i) {
            var o = {
                ...
                publisherIdType: n,
                callbackName: "trkCallback" + (0 === h ? "" : h),
                metadata: i
            };
            return o[S] = I, p[t] || (p[t] = []), p[t].push(o), ++h, o
        },
        oe = function e(t) {
            return function() {
                ne(t)
        ...
        ae = function t(r, i, o, a) {
            var s = n.rboxTrcProtocol + "//trc.taboola.com/" + r + "/trc/3/json?" + "tim=" + (new Date).getTime() + "&" + "data=" + encodeURIComponent(JSON.stringify(ce(a))) + "&" + "pubit=" + i,
                c = o.isMediaRequest ? e._tfa.config.safeGet("tfa:trk:tracking-request-timeout", T, r) : E;
            a[S] = C, a[m] = e.setTimeout(oe(a), c), a.newScriptElement = re(s, function() {
                a[b] = !0
            })
        },
        se = function e(t) {
        ...
        fe = function t(i, o) {
            if (e.clearTimeout(i[m]), o && o.trc) {
                if (o.trc.ui ? (o.trc["DNT"] && "TRUE" === o.trc["DNT"].toUpperCase() ? localStorage.removeItem("taboola global:user-id") : o.trc["cm"] || localStorage.setItem("taboola global:user-id", o.trc["ui"]), F = B.USER_ID_SET) : F = B.UNINITIALIZED, o.trc.sd && !o.trc["cm"] && localStorage.setItem(i.publisherId + ":session-data", o.trc["sd"]), o.trc["vl"] && o.trc["vl"].length) {
                    var a = o.trc["vl"][0].ri;
                    i.isMediaRequest || (e.TRC.events_ri = a), i[y] = a, i[S] = k, r.eventUtils.dispatchEvent(r.sharedEvents.REQUEST_ID_CREATED, {
            ...
            i[S] !== k && (i[S] = R, r.eventUtils.dispatchEvent(r.sharedEvents.REQUEST_ID_CREATION_ERROR, {
                publisherId: i.publisherId
            })), i.isMediaRequest || (e.TRC.trkRequestStatus = !(P.indexOf(i[S]) >= 0)), e.TRC.alertVVResponseLoaded && e.TRC.alertVVResponseLoaded(n.tblVersion), te(i), le()
        },
        de = function() {
            var e, t = function e() {
                    try {
        ...
        ge = function t() {
            ...
            var n = 400,
                r;
            return (K = e.location.search).length > n && (r = K.substring(0, n - 1), K = r.substring(0, r.lastIndexOf("&"))), K
        },
        ve = function e(t) {
            var n = Se("usprivacy");
    ...
    var ye = function e(t) {
        ...
        be = function t(o, a) {
            var s = {},
                ...
                p = {},
                h;
            return e._tfa.config.safeGet("tfa:trk:collect-cookie-banner-consent:enabled", !0, n.bakedPublisherId) && (p = r.trk.parseCookieBanner()) && (a.cbp = p.cookieBannerProvider.providerName, a.cbpv = p.cookieBannerProvider.version, p.cookieBannerConsent.tcString && e._tfa.config.safeGet("tfa:trk:send-tc-string:enabled", !0, n.bakedPublisherId) ? (a.tcs = p.cookieBannerConsent.tcString, p.cookieBannerConsent.gdprApplies && (a.ga = p.cookieBannerConsent.gdprApplies), p.cookieBannerConsent.cmpStatus && (a.cmps = p.cookieBannerConsent.cmpStatus)) : p.cookieBannerConsent.consentData && (a.cbcd = p.cookieBannerConsent.consentData)), i.forEach(function(e) {
                var t = c[e];
                ...
                a.ccpa = e
            }), e._tfa.config.safeGet("tfa:trk:collect-gpp", !1, n.bakedPublisherId) && ye(function(e) {
        ...
        Te = function e(t) {
            var n = Ee(t);
            return ke() && he(n), t.isMediaRequest && (n = be(t, n)), n
        },
        Ie = function e(t) {
        ...
        we = function e(t) {
            var r = null;
            return u || "" === u ? r = u : (l || "" === l) && (r = l), ("" === r || t.isMediaRequest) && (r = Pe("item-id", n.normalizeItemId, n.prenormalizeIdRules)), r
        },
        _e = function e(t, n, r) {
            var o;
            if (!r) return n;
            ...
            for (var a = new Y(n), s = i.objKeys(r), c = 0; c < s.length; ++c) {
                ...
                if (r[u]) switch (u) {
                    ...
                    case "query":
                        ...
                        break;
                    case "fragment":
                        var p = a.hash.replace(/^#/, "");
                        "string" == typeof(o = r[u]) && (o = new RegExp(o)), a.hash = "", o instanceof RegExp && o.test(p) ? a.hash = "#" + p : o instanceof Array && o.forEach(function(e) {
                            p.search(e) >= 0 && (a.hash = "#" + p)
                        })
                }
            }
        ...
        ke = function e() {
            return Oe(pe(), "ampproject.net")
        },
        Re = function e() {
            return Oe(pe(), "instantarticles.fb.com")
        },
        Oe = function e(t, n) {
            try {
        ...
        Pe = function e(t, r, i) {
            var o = ["paramUrl", "meta", "canonical", "og", "location"],
                ...
                l, f, d, p = "",
                h = function e(t, n) {
                    return _e.call(this, t, n, i)
                };
            for (s.push("location"); c < s.length && (!p || /^\s*$/.test(p));) f = s[c], p = (l = a[s[c]]) ? l.call(null, t, h) : null, c++;
            return "item-url" === t && f === Ue ? p : (d = f !== Ne, p = "function" == typeof r ? r.call(this, p, u ? "video" : "text", d) : p)
        },
        Ue = function e(t, n) {
        ...
        Be = function e() {
            for (var n = Ve(t.getElementsByTagName("script")), r = [{
                    key: "?",
                    index: 0
                }, {
                    key: "://",
                    ...
                    key: "/",
                    index: 0
                }], i = 0, o = r.length, a = n, s; i < o; i++) a = (s = J(a, r[i].key, 2)).length > 1 ? s[r[i].index] : s[0];
            return a
        },
        Fe = function t() {
            if (!e.TRC.AdServerManager) {
                var r = Be();
                e.TRC.VVReady = Ge, re("//" + r + "/libtrc/vv." + n.tblVersion + ".js")
            }
        },
        Ge = function t() {
        ...
        $e = function e(t, n, r) {
            ...
            var a = (o.host || location.host).toLowerCase(),
                ...
                h, g, v, m, y;
            if (!u) {
                for (ee(r, p), p.sort(function(e, t) {
                        return e[0].length > t[0].length ? -1 : e[0].length < t[0].length ? 1 : 0
                    }), h = 0, g = p.length; h < g; h++)
                    if ((v = p[h][0].toLowerCase()).indexOf(l) > 0) {
                        if (s.match(v)) {
                            u = Ke(p[h][1], c);
                            break
                        }
                ...
                if (!u && a.indexOf("www.") < 0) {
                    for (h = 0, g = d.length; h < g && (m = new RegExp("(https://|http://|^)" + d[h] + "."), y = a.replace(m, "www."), !(u = Ke(r[y], c))); h++);
                    u || (u = Ke(r[y = "www." + a], c))
                }
            }
    ...
    e.TRC = e.TRC || {}, e.TRC.trk = r.trk = e.TRC.trk || {
        init: function t() {
            r.trk.parseCookieBanner(), e.TRC.utm && !W() || (W() || g || (e.TRC._getGlobalRequestId = Ce, e.TRC._getItemId = we, e.TRC._getItemType = Le, g = !0), e.TRC.hasTrk ? W() || r.trk.execute() : e._tfa && !e._tfa.config.hasValidConfig() || (r.hasTrk = !0, z() && (r.eventUtils.safeAddEventListener(r.sharedEvents.PAGE_VIEW, function(t) {
                try {
                    var i = t.detail,
                        o = i.publisherIdType,
                        a = i.accountId,
                    ...
                    if (Ie(e._taboola), u) {
                        ...
                        e._tfa.config.safeGet("tfa:trk:network-solution-enabled", !1, a) && (a = $e(a, o, n.networkMap))
                    }
                    d = ie(a, o, f = {
                        pageViewInitiator: s,
                        isMediaRequest: u,
        ...
        execute: function t() {
            var i = r.publisherIdType.NAME,
                o = $e(n.bakedPublisherName, i, n.networkMap);
        ...
        hasRequestEnded: function e(t) {
            return He(t, function(e) {
                return P.indexOf(e) > -1 || !(U.indexOf(e) > -1)
            }, !1)
        },
        getPublisherRequestId: function e(t) {
            var n = ue(t);
            return n && n[S] === k ? n[y] : null
        },
    ...
    bakedPublisherId: 1926284,
    bakedPublisherName: 'taboolaaccount-ajayemergentsh',
    tblVersion: "20260215-2-RELEASE",
...
function(e, t) {
    ...
    function i() {
        ...
        function l() {
            ...
            r = t.length > 0 ? 1 : -1, i = new Date((new Date).getTime() + 365 * r * 864e5);
            var a = "",
                s = document.domain.match(/[^\.]*\.[^.]*$/);
            s && s.length > 0 && (a = ";domain=." + s[0]), document.cookie = e + "=" + escape(t.join("|")) + ";path=/;expires=" + i.toUTCString() + a
        }
...
function(e, t, n) {
    ...
    function l(e, t, n) {
        for (var r = {}, i = 0; i < arguments.length; i++) u(arguments[i], r);
    ...
    n.tfaUserId = {
        ...
        getClickIdSource: function e() {
            return this.clickIdSource
        },
        ...
        sendUserIdsToTrc: function t(r, i, o, a) {
            var s, c = 'https:',
                u = [];
            if (l(r, i, o)) return n.tfaUtil.safeAddParam("uiref", r, u), n.tfaUtil.safeAddParam("uils", i, u), n.tfaUtil.safeAddParam("uifpc", o, u), n.tfaUtil.safeAddParam("tblci", a, u), s = new Image, e._tfa.config.safeGet("tfa:add-referrer-policy-when-firing-pixel", !0) && (s.referrerPolicy = "no-referrer-when-downgrade"), s.src = c + "//trc.taboola.com/sg/taboola-tfa/1/um/?" + u.join("&"), s
        },
        ...
        readAndStoreClickIdParam: function e() {
            var t = this.extractClickIdFromUrl(this.getWindowLocation().toString()) || this.extractClickIdFromUrl(this.getReferrer()),
                ...
                i = t ? t.source : null,
                a = r.getValue(o);
            n ? (r.storePublisherValue(r.TABOOLA_GLOBAL_KEY, o, n), this.clickId = n, this.clickIdSource = i) : a && (this.clickId = a, this.clickIdSource = c.LOCAL_STORAGE)
        },
        ...
        searchAllParameterValuesForClickId: function t(r) {
            var i = e._tfa.config.safeGet("tfa:search-click-id-in-query-string-prefix", "tbl");
            if (i && r)
                for (var o = n.TFA_URL.prototype.getQueryStringObj.call(r), a = Object.keys(o), s = 0; s < a.length; s++) {
                    var c = o[a[s]],
                        u = decodeURIComponent(c);
                    if (u && 0 === u.indexOf(i)) return u
                }
        },
        extractClickIdFromUrl: function t(r) {
            if (r) {
                var i = r.length > 1 && -1 !== r.indexOf("#") ? r.substring(r.indexOf("#")) : "",
                    a, u;
                if (a = n.tfaUtil.getParameterByName(o, r)) return {
                    clickId: a,
                    source: c.QUERY
                };
                if (i && i.length > s.length && 0 === i.indexOf(s)) return {
                    clickId: i.substr(s.length),
                    source: c.HASH
                };
                if (e._tfa.config.safeGet("tfa:search-click-id-in-query-string-enabled", !0) && (u = this.searchAllParameterValuesForClickId(r))) return {
                    clickId: u,
                    source: c.CUSTOM_QUERY
                }
            }
        },
        ...
        init: function e() {
            this.initialized || (this.readAndStoreClickIdParam(), this.readAndStoreUserId(), this.initialized = !0)
        }
    }, n.tfaUserId.init(), n.tfaUserId.CLICK_ID_KEY = o, n.tfaUserId.CLICK_ID_SOURCE = c
}(window, document, window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC']),
function(e, t) {
    var n = "_tfa",
        r = e[n] = e[n] || [],
    ...
    g.prototype = {
        ...
        init: function e(n) {
            if (d = r.config.safeGet("tfa:engagement:session-duration-in-milliseconds", c), !this.isInitialized()) {
                ...
                if (this.getIsLocalStorageAvailable()) return a = o && o.sessionStartTime, p.call(this, o, i, n), a && !this.isSessionInvalid(o) || (a = i, this.persistDefaultValues(a)), s = !0, this
            }
        },
        ...
        getSessionDataFromStorage: function e() {
            ...
            if (r = i && JSON.parse(i)) return this.isSessionInvalid(r) ? r : !h.call(this, r) || this.hasSessionEnded() ? (this.resetStorageMetricData(), r) : r
        },
...
function(e, t) {
    ...
    function w(e, t) {
        var n = C(e, t);
        n.est && (i.pageViewAccountIds ? _(i.pageViewAccountIds, n) : k(n))
    }
    ...
    function P(e) {
        (isNaN(b) || b < 0) && (b = 0), a.hasSessionEnded() || (b++, a.persistSpecificMetricsData(m, b), U() || o.sendMetrics("i", e), A())
    }
    ...
    function D(e) {
        var t;
        return t = 0 === e ? 4500 : 1 === e ? 5500 : e > 1 && e <= 9 ? 1e4 : h * Math.pow(2, e - 3)
    }

    function A() {
        if (clearTimeout(E), T && !d.getIsPageHidden()) {
            var e, t = r.config.safeGet("tfa:engagement:use-new-interval-calculation", !1) ? D(b) : h * Math.pow(2, b);
            t !== 1 / 0 && (E = setTimeout(P, t, t))
        }
    }
    ...
    function M() {
        p.subscribeToEvent(j.bind(this)), d.subscribeToEvent(x.bind(this))
    }

    function x() {
        d.getIsPageHidden() ? O() : A()
    }
    ...
    function j(e) {
        ...
        L(), e && T && !d.getIsPageHidden() && t(e) && (T = !1, O(), V(g, v, N, O))
    }
    ...
    function B() {
        o.initialized || r.config.safeGet("tfa:engagement:is-manager-disabled", !1, 1926284) || (i = r.TUP || {}, o.initialized = !0, o.ESU.init(R), d.init(), p.init(a), M(), o.ESU.getIsLocalStorageAvailable() && (f.init(a), u.init(a, p, d), s.init(a, p), c.init(a, p, t.sharedEvents.PAGE_VIEW), l.init(a, p, f), o.initIntervalTrigger()), V(g, v, N, O))
    }
    o.init = o.init || B, o.onSessionEndTrigger = o.onSessionEndTrigger || R, o.sendMetrics = o.sendMetrics || w, o.initIntervalTrigger = o.initIntervalTrigger || N, o.EVENTS = o.EVENTS || S
}(window, window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC']),
function(e, t) {
    var n = "_tfa",
        r = e[n] = e[n] || [],
    ...
    t.lastExternalReferrer = {
        init: function e() {
            r.config.safeGet("tfa:last-external-referrer:is-disabled", !1, 1926284) || this.extractExternalReferrerIfExistsAndStoreLocally()
        },
        ...
        updateUrl: function e(t, n) {
            for (var r = t.getAttribute(n), i = 0; i < s.length; i++) {
                ...
                if (!(null !== this.getQueryParamFromSearch(r, s[i]) || null !== this.getQueryParamFromHash(r, s[i]))) {
                    ...
                    if (d) {
                        var p = s[i] + "=" + d;
                        return c.TFA_URL.prototype.addParamsToUrl.call(t, r, p)
                    }
                }
            }
            return r
...
function(e, t, n) {
    var r = "tfa:allow-codeless-tracking",
        i = "tfa:codeless-domain-override",
        o = "taboola-codeless-active",
        a = n.jsScope,
        s = n.publisherId;

    function c() {
        return t.referrer && "string" == typeof t.referrer && t.referrer.indexOf("ads.realizeperformance.com") > -1
    }
    ...
    function l() {
        (c() || u()) && e._tfa && e._tfa.config && e._tfa.config.safeGet && e._tfa.config.safeGet(r, !1, s) && a.codeless.init()
    }
    e.TRC = e.TRC || {}, e.TRC.codeless = a.codeless = e.TRC.codeless || {
        shouldUseCspBypass: function t() {
            return !!(e._tfa && e._tfa.config && e._tfa.config.safeGet) && !0 === e._tfa.config.safeGet(i, !1, s)
        },
        init: function e() {
            this.loadCodelessScript()
        },
        loadCodelessScript: function n() {
            var r = t.createElement("script"),
                i, o = this.shouldUseCspBypass() ? "https://code.taboola.com" : "https://ads.realizeperformance.com";
            e.__CODELESS_APP_HOST__ = o;
            var a = o + "/resources/codeless/codeless-events.js",
                s = (new Date).getTime();
            r.src = a + "?t=" + s, r.async = !0, r.type = "text/javascript", r.id = "codeless_script", t.head.appendChild(r)
        }
    }, e.TRC.codelessInit = a.codelessInit = l, l()
}(window, document, {
    publisherId: 1926284,
    jsScope: window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC']
}),
function(e, t, n) {
    var r = n.jsScope;
    e.TRC = e.TRC || {};
    var i = "advancedMatching",
        o = "originalMatching",
        a = "tfa:tfa-codeless-tracking:advanced-matching",
        s = "tfa:allow-codeless-debug-events",
        c = "tfa:tfa-codeless-tracking:selector-matching-by-native-css";

    function u() {
        if (!isNaN(parseInt(n.publisherId, 10))) return n.publisherId;
        if (e._tfa && e._tfa.config && e._tfa.config.firstPublisherId) {
            var t = e._tfa.config.firstPublisherId;
            if (!isNaN(parseInt(t, 10))) return t
        }
        return null
    }
    e.TRC.codelessTrackingInit = r.codelessTrackingInit = function() {
        var l, f = u();
        if (f) {
            var d = "codelessTracking-" + f,
                p = "string" == typeof n.publisherName && -1 === n.publisherName.indexOf("${") ? n.publisherName : null;
            e.TRC[d] = r[d] = e.TRC[d] || (_defineProperty(l = {
                trackedElements: [],
                init: function e() {
                    this.trackedElements = this.getTrackedElements(), this.trackedElements.length && this.setupClickTracking()
                },
                getTrackedElements: function t() {
                    var n = e._tfa && e._tfa.config && e._tfa.config.trackedElements || [];
                    ...
                    return "object" === _typeof(n) ? Object.values(n) : []
                },
                setupClickTracking: function e() {
                    t.addEventListener("click", this.handleClick.bind(this), !0)
                },
                extractElementText: function e(t) {
                    var n = "";
                    return !n && t && void 0 !== t.textContent && (n = t.textContent.trim()), t && void 0 !== t.innerText && (n = t.innerText.trim()), !n && t && (n = t.getAttribute("aria-label") || t.getAttribute("data-text") || t.getAttribute("title") || ""), n.trim()
                },
                extractHref: function e(t) {
                    if (t) {
                        if (t.tagName && "a" === t.tagName.toLowerCase() && t.href) return t.href;
                        var n = t.closest("a");
                        return n ? n.href : void 0
                    }
                },
                handleClick: function e(t) {
                    var n = t.target;
                    if (this.trackedElements && this.trackedElements.length) {
                        var r = t && t.target && t.target.form;
                        if (!r || r.checkValidity()) {
                            var i = this.findAllMatchingTrackedElements({
                                clickedElement: n,
                                sendCodelessDebugEvents: this.isCodelessDebugEventsAllowed(),
                                isAdvancedMatchingEnabled: this.isAdvancedMatchingEnabled(),
                                isSelectorMatchingByNativeCSSEnabled: this.isSelectorMatchingByNativeCSSEnabled(),
                                publisherName: p
                            });
                            if (i && i.length) {
                                var o = this;
                                i.forEach(function(e) {
                                    e.eventNames && e.eventNames.length && e.eventNames.forEach(function(e) {
                                        o.pushEvent(e)
                                    })
                                })
                            }
                ...
                isCodelessDebugEventsAllowed: function t() {
                    return e._tfa && e._tfa.config && e._tfa.config.safeGet && e._tfa.config.safeGet(s, !1, f)
                },
                isAdvancedMatchingEnabled: function t() {
                    return e._tfa && e._tfa.config && e._tfa.config.safeGet && e._tfa.config.safeGet(a, !1, f)
                },
                isSelectorMatchingByNativeCSSEnabled: function t() {
                    return e._tfa && e._tfa.config && e._tfa.config.safeGet && e._tfa.config.safeGet(c, !1, f)
                },
                getFeatureFlag: function t(n, r) {
                    return e._tfa && e._tfa.config && e._tfa.config.safeGet && e._tfa.config.safeGet(n, r || !1, f)
                }
            }, "isCodelessDebugEventsAllowed", function e() {
                return this.getFeatureFlag(s)
            }), _defineProperty(l, "isAdvancedMatchingEnabled", function e() {
                return this.getFeatureFlag(a)
            }), _defineProperty(l, "isSelectorMatchingByNativeCSSEnabled", function e() {
                return this.getFeatureFlag(c)
            }), _defineProperty(l, "findAllMatchingTrackedElements", function e(t) {
                var n = t.clickedElement,
                    r = this.getElementPath(n),
                    i = this.extractElementText(n),
                    o = this.extractHref(n),
                    a = t.sendCodelessDebugEvents,
                    s = t.publisherName,
                    c = t.isAdvancedMatchingEnabled,
                    u = t.isSelectorMatchingByNativeCSSEnabled;
                try {
                    var l;
                    return this.trackedElements.filter(function(e) {
                        var t = this.isElementMatched({
                            clickedElement: n,
                            trackedElement: e,
                            legacyElementPath: r,
                            elementText: i,
                            elementHref: o,
                            isAdvancedMatchingEnabled: c,
                            isSelectorMatchingByNativeCSSEnabled: u
                        });
                        return t.isMatch && a && this.sendCodelessDebugEvent({
                            matchInfo: t,
                            publisherName: s
                        }), t.isMatch
                    }.bind(this))
                } catch (e) {
                    var d = n ? n.tagName : null;
                    return this.sendCodelessErrorEvent({
                        error: e,
                        functionName: "findAllMatchingTrackedElements",
                        publisherId: f,
                        additionalContext: {
                            clickedElementTag: d
                        }
            ...
            }), _defineProperty(l, "isElementMatched", function e(t) {
                var n = t.clickedElement,
                    r = t.trackedElement,
                    a = t.legacyElementPath,
                    s = t.elementText,
                    c = t.elementHref,
                    u = t.isAdvancedMatchingEnabled,
                    l = t.isSelectorMatchingByNativeCSSEnabled;
                if (!r) return {
                    isMatch: !1
                };
                var f = this.isMatchedBySelector({
                        clickedElement: n,
                        trackedSelector: r.selector,
                        legacyElementPath: a,
                        isSelectorMatchingByNativeCSSEnabled: l
                    }),
                    d = this.hasValidDisplayText(r.displayText),
                    p = !!d && this.isMatchedByDisplayText(r.displayText, s),
                    h = this.isMatchedByHref(r.href, c),
                    g;
                return g = u ? !!h || (r.selector ? d ? f && p : f : p) : f || p, {
                    legacyElementPath: a,
                    elementText: s,
                    elementHref: c,
                    trackedElementSelector: r.selector,
                    trackedElementDisplayText: r.displayText,
                    trackedElementHref: r.href,
                    isMatchedBySelector: f,
                    isMatchedByDisplayText: p,
                    isMatchedByHref: h,
                    isMatch: g,
                    eventNames: r.eventNames,
                    matchingStrategy: u ? i : o
                }
            }), _defineProperty(l, "isMatchedBySelector", function e(t) {
                var n = t.clickedElement,
                    r = t.trackedSelector,
                    i = t.legacyElementPath,
                    o = t.isSelectorMatchingByNativeCSSEnabled;
                if (!r) return !1;
                var a = function e() {
                    return i.includes(r)
                };
                if (!o) return a();
                try {
                    return !!n.matches(r) || !!n.closest(r);
                    var s
                } catch (e) {
                    var c = n ? n.tagName : null;
                    return this.sendCodelessErrorEvent({
                        error: e,
                        functionName: "isMatchedBySelector",
                        publisherId: f,
                        additionalContext: {
                            trackedSelector: r,
                            clickedElementTag: c
            ...
            }), _defineProperty(l, "unescapeEmojis", function e(t) {
                return t ? t.replace(/\\u\{([0-9a-fA-F]+)\}/g, function(e, t) {
                    var n = parseInt(t, 16);
                    return String.fromCodePoint(n)
                }) : ""
            }), _defineProperty(l, "normalizeWhitespace", function e(t) {
                return t && "string" == typeof t ? t.replace(/\s+/g, " ").trim() : ""
            }), _defineProperty(l, "hasValidDisplayText", function e(t) {
                return t && "string" == typeof t && t.trim().length > 0
            }), _defineProperty(l, "isMatchedByDisplayText", function e(t, n) {
                if ("string" != typeof n) return !1;
                var r = this.normalizeWhitespace(this.unescapeEmojis(t)).toLowerCase(),
                    i;
                return this.normalizeWhitespace(n).toLowerCase().includes(r)
            }), _defineProperty(l, "isMatchedByHref", function e(t, n) {
                return !(!t || "string" != typeof t || void 0 === n || !n.toLowerCase().includes(t.toLowerCase()))
            }), _defineProperty(l, "sendLogMessage", function e(t, n, r) {
                if (r) try {
                    var i = new Date,
                        o = i.toTimeString().slice(0, 8).replace(/:/g, "%3A") + "." + i.getMilliseconds().toString().padStart(3, "0"),
                        a = new URL("https://trc.taboola.com/" + r + "/log/2/debug"),
                        s;
                    a.searchParams.set("tim", o), a.searchParams.set("type", n), a.searchParams.set("msg", JSON.stringify(t)), (new Image).src = a.toString()
                } catch (e) {}
            }), _defineProperty(l, "sendCodelessDebugEvent", function e(t) {
                var n = t.matchInfo,
                    r = t.publisherName;
                this.sendLogMessage(n, "CODELESS_TRACKING", r)
            }), _defineProperty(l, "sendCodelessErrorEvent", function e(t) {
                var n = t.error,
                    r = t.functionName,
                    i = t.publisherId,
                    o = t.additionalContext,
                    a = void 0 === o ? {} : o,
                    s, c, u = {
                        errorMessage: "string" == typeof n ? n : n && n.message ? n.message : "Unknown error",
                        errorStack: n && n.stack ? n.stack : void 0,
                        functionName: r,
                        publisherId: i,
                        additionalContext: a,
                        timestamp: (new Date).toISOString()
                    };
                this.sendLogMessage(u, "CODELESS_ERROR", p)
            }), _defineProperty(l, "pushEvent", function t(r) {
                try {
                    var i = f;
                    if (!i) return void this.sendCodelessErrorEvent({
                        error: "Could not find valid publisher id",
                        functionName: "pushEvent",
                        publisherId: null,
                        additionalContext: {
                            eventName: r,
                            configPublisherId: n.publisherId,
                            tfaFirstPublisherId: e._tfa && e._tfa.config && e._tfa.config.firstPublisherId
                        }
                    });
                    i = parseInt(i, 10), e._tfa.push({
                        notify: "event",
                        name: r,
                        id: i
                    })
                } catch (e) {
                    this.sendCodelessErrorEvent({
                        error: e,
                        functionName: "pushEvent",
                        publisherId: f,
                        additionalContext: {
            ...
            }), _defineProperty(l, "getElementPath", function e(n) {
                for (var r = [], i = n; i && i !== t;) {
                    var o = i.tagName.toLowerCase(),
                        a = i.id ? "#" + i.id : "",
                        s = "";
                    i.className && (s = "." + Array.from(i.classList || i.className.split(" ")).join(".")), r.unshift(o + a + s), i = i.parentElement
                }
                return r.join(" > ")
            }), l), h()
        }
        ...
        function h() {
            e._tfa && e._tfa.config && ("complete" === t.readyState || "interactive" === t.readyState ? setTimeout(function() {
                r[d].init()
            }, 0) : t.addEventListener("DOMContentLoaded", function() {
                r[d].init()
            }))
        }
    }, e.TRC.codelessTrackingInit()
}(window, document, {
    publisherName: 'taboolaaccount-ajayemergentsh',
    publisherId: 1926284,
    jsScope: window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC']
}),
function(e, t, n) {
    ...
    function w() {
        ...
        e.initialized && e.domAccountId && setTimeout(function() {
            for (var e = ge().asyncQueue; e.length;) ve(e.shift())
        }, 0)
    }
    ...
    function _() {
        var e = k(),
            t;
        if (e && e.src && (t = e.src.replace(c, "$3"))) return /^\d+$/.test(t) ? parseInt(t, 10) : (ye("Value '" + t + "' is invalid for 'id' param in script source url '" + e.src + "'. Only numeric values are allowed."), g)
    }
    ...
    function D() {
        try {
            ...
            ye("Error while trying to add user-id param", e)
        }
    }
    ...
    function A(e) {
        try {
            ...
            ye("Error while trying to addClickIdParam, params=" + JSON.stringify(e), t)
        }
    }

    function N(e, n) {
        try {
            if (!o.config.safeGet("unip:add-click-id-source", !1, n)) return;
            var r = t.tfaUserId.getClickIdSource();
            r && (e["cis"] = r)
        } catch (t) {
            ye("Error while trying to addClickIdSourceParam, params=" + JSON.stringify(e), t)
        }
    }

    function L(e) {
        var n = ge();
        n.referrer || (n.referrer = t.trk.getReferrer()), e[h.referrer] = n.referrer
    }

    function M(e, t) {
        var n = h.url,
            r;
        ke(Ee(e), t) && (e[n] = e[n] || document.location.href)
    }
    ...
    function x(e) {
        var t = {},
            n = !1,
            r;
        for (var i in e[h.timestamp] = R(), e) !e.hasOwnProperty(i) || d.indexOf(i) >= 0 || (t[r = h.hasOwnProperty(i) ? h[i] : i] = e[i], n = !0);
        return n && t
    }
    ...
    function V(e) {
        window.location.protocol.startsWith("https") && document.featurePolicy && document.featurePolicy.allowedFeatures() && -1 !== document.featurePolicy.allowedFeatures().indexOf("attribution-reporting") && (e.modifiers = e.modifiers || [], e.modifiers.push(B))
    }

    function B(e) {
        if ("function" == typeof e.setAttributionReporting) {
            var t = {
                eventSourceEligible: !1,
                triggerEligible: !0
            };
            e.setAttributionReporting(t)
        }
    }
    ...
    function G() {
        200 === this.status && F(this.responseText)
    }

    function K(e) {
        return !!(t.privacySandbox && t.privacySandbox.isProtectedAudienceSupported() && e && "pre_d_eng_tb" !== e[h.name]) && (e["psb"] = "true", !0)
    }

    function $(e, n) {
        var r = Te(e) + l + Ie(e, n),
            i, o;
        ne(n, e), q(n, e), V(n), (o = K(n)) && (i = G);
        try {
            t.TRCLogger[v.httpMethod](r, v.loggerEventName, n, e, i)
        } catch (t) {
            ye("Error while trying to send to server event with id '" + e + "' and params '" + JSON.stringify(n) + "'.", t)
        }
    }
    ...
    function H(e) {
        var t = D(),
            n = e[T];
        if (n) {
            if (!t) return Se("No UserId to notify callback"), void delete e[T];
            if ("function" != typeof n) return Se("Callback function parameter is not a function " + n), void delete e[T];
            try {
                n({
                    userId: t
                })
            } catch (e) {
                ye("Error calling advertiser callback", e)
            }
            delete e[T]
        }
    }
    ...
    function q(e, t) {
        U(e), A(e), N(e, t), L(e), ce(e), M(e, t), J(e), Q(e), ee(e, t), z(e, t), te(e, t), W(e)
    }
    ...
    function W(e) {
        var t = h.integrationType,
            n = e[t];
        n ? n !== p && (r.currentIntegrationType = n) : r.currentIntegrationType ? e[t] = r.currentIntegrationType : (r.scriptIntegrationType || (r.scriptIntegrationType = Re(), r.scriptIntegrationType && r.scriptIntegrationType !== p && (r.currentIntegrationType = r.scriptIntegrationType)), r.scriptIntegrationType ? e[t] = r.scriptIntegrationType : e[t] = p)
    }
    ...
    function J(e) {
        e && a && a.ESU && a.ESU.getIsLocalStorageAvailable() && (Y(e), X(e), Z(e))
    }
    ...
    function ue(e, n) {
        ...
        if (!t.trk.getPublisherRequestId(e)) {
            if (t.trk.isRequestProcessing(e)) return void r.messageDelayer.delayMessage(e, n, {
                ...
                timeoutInMillis: be(e)
            });
            se(n, t.trk.getRequestStatus(e))
        }
        $(e, n)
    }
    ...
    function le(e, n) {
        ...
        if (n = parseInt(n, 10), !o || !o(r, n)) {
            if (we(n)) {
                if (_e(n)) return void ue(n, r);
                t.trk.getPublisherRequestId(n) || se(r, "wffo")
            } else se(r, "ttd");
            $(n, r)
        }
    }
    ...
    function de(e, t) {
        var n = x(e);
        re(e, n), $(parseInt(t, 10), n)
    }

    function pe(e, n) {
        var r = ge(),
            i = !1;
        return n && (i = Ce(n), q(e), r.pageViewAccountIds[n] = parseInt(n, 10), t.eventUtils.dispatchEvent(t.sharedEvents.PAGE_VIEW, {
            accountId: n,
    ...
    function he(e) {
        return e ? e.notify ? s.hasOwnProperty(e.notify) ? e.name ? !(e.hasOwnProperty("id") && !/^\d+$/.test(e.id)) || (me(m.INVALID_ID, e, "Value '" + e.id + "' is invalid for 'id' field in command '" + JSON.stringify(e) + "'. Only numeric values are allowed."), !1) : (me(m.MISSING_NAME, e, "Mandatory 'name' field is missing in command '" + JSON.stringify(e) + "'."), !1) : (me(m.INVALID_NOTIFY, e, "Value '" + e.notify + "' is invalid for 'notify' field in command '" + JSON.stringify(e) + "'."), !1) : (me(m.MISSING_NOTIFY, e, "Mandatory 'notify' field is missing in command '" + JSON.stringify(e) + "'."), !1) : (me(m.EMPTY_COMMAND, e, "Command is '" + e + "'."), !1)
    }
    ...
    function ve(e) {
        var t, n;
        if (he(e))
            if (t = ge(), n = e.id || t.domAccountId) {
                if (n !== g) try {
                    s[e.notify](e, n)
                } catch (t) {
                    ye("An error occurred while handling command '" + JSON.stringify(e) + "'.", t)
                }
    ...
    function me(e, n, r) {
        var i = ge();
        t.eventUtils.dispatchEvent(y.TFA_VALIDATION_ERROR, {
    ...
    function Te(e) {
        return o.config.safeGet("tfa:default-protocol", v.protocol, e)
    }

    function Ie(e, t) {
        var n = Ee(t),
            r;
        return o.config.safeGet("tfa:event-host-map", {}, e)[n] || v.host
    }

    function Ce(e) {
        return we(e) && o.config.safeGet("tfa:trk:is-unified-page-view", !1, e)
    }
    ...
    function Re() {
        var e = k(),
            t;
        if (e && e.src && (t = e.src.match(/[?&]it=([^&]+)/)) && t[1]) try {
    ...
    function Oe() {
        ...
        e.domAccountId = e.domAccountId || (n && E ? 1926284 : _()), e.initialized || (e.push = o.TUP.push || ve, e.initialized = !0, e.asyncQueue = [], e.EVENTS = y, e.pageViewAccountIds = {}, e.messageDelayer = new t.MessageDelayer("publisherId", t.sharedEvents.REQUEST_ID_CREATED, [t.sharedEvents.REQUEST_ID_CREATION_JS_ERROR, t.sharedEvents.REQUEST_ID_CREATION_ERROR, t.sharedEvents.REQUEST_ID_CREATION_TIMEOUT, t.sharedEvents.INVALID_TRK_RESPONSE]), a && a.init && a.init(), r.scriptIntegrationType = Re(), r.scriptIntegrationType && r.scriptIntegrationType !== p && (r.currentIntegrationType = r.scriptIntegrationType)), w()
    }
    Oe()
}(window, window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC'], "20260215-2-RELEASE"),
function(e, t, n) {
    var r = "_tfa",
        i, o = {
            orderid: "orderid",
    ...
    function g(e) {
        ...
        switch (e.notify) {
            ...
            case "ecevent":
                ...
                n || r ? t = window[d] = window[d] || [] : i.config && i.config.safeGet("tfa:dco:jobs:enabled", !1, e.id) && (t = window[p] = window[p] || []);
                break;
            default:
                return
        }
    ...
    function y() {
        var t, n, r, i;
        if (r = e._tfa.config.safeGet("tfa:get-publisher-id-from-baker", !1) && h ? 1926284 : _())
            for (t = 0, n = l.length; t < n; t++) E(b(s, {
                $publishreId: r ? r + "/" : "",
                $logType: "action"
            }) + "tim=" + escape(I()) + "&item-url=" + escape(T()) + k(o, l.shift()) + C() + v() + m())
    }

    function S() {
        var t, n, r, i;
        if (r = e._tfa.config.safeGet("tfa:get-publisher-id-from-baker", !1) && h ? 1926284 : _())
            for (t = 0, n = f.length; t < n; t++) E(b(s, {
                $publishreId: r ? r + "/" : "",
                $logType: "mark"
            }) + "tim=" + escape(I()) + "&item-url=" + escape(T()) + k(a, f.shift()) + C() + v() + m())
    }
    ...
    function C() {
        var n = e.location.search,
            ...
            i = "";
        return i = w(n.replace(/^\?/, "").split(/&/)) + (r ? w(r[0].replace(/^\?/, "").split(/&/)) : "")
    }
    ...
    function U() {
        (i = e[r] = e[r] || []).registered || (i.push = R, i.registered = !0, P())
    }
    U()
}(window, document, window['TFASC'.indexOf("{jsScope}") >= 0 ? "TRC" : 'TFASC']);