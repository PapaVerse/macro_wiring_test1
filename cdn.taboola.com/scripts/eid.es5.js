function _createForOfIteratorHelper(b, t) {
    var W = "undefined" != typeof Symbol && b[Symbol.iterator] || b["@@iterator"];
    if (!W) {
        if (Array.isArray(b) || (W = _unsupportedIterableToArray(b)) || t && b && "number" == typeof b.length) {
            W && (b = W);
            var c = 0,
                m = function b() {};
            return {
...
function _unsupportedIterableToArray(b, t) {
    if (b) {
        ...
        return "Object" === W && b.constructor && (W = b.constructor.name), "Map" === W || "Set" === W ? Array.from(b) : "Arguments" === W || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(W) ? _arrayLikeToArray(b, t) : void 0
    }
}

function _arrayLikeToArray(b, t) {
    (null == t || t > b.length) && (t = b.length);
    for (var W = 0, c = new Array(t); W < t; W++) c[W] = b[W];
    return c
}
...
! function(b, t) {
    try {
        var W = function b(t) {
                var W;
                try {
                    return W = window.atob(S), t && t.type && -1 != t.type.toLowerCase().indexOf(W) || t.id && -1 != t.id.toLowerCase().indexOf(W) || t.name && -1 != t.name.toLowerCase().indexOf(W)
                } catch (b) {
                    return !1
                }
            },
            c = function b(t) {
                ...
                if (-1 !== I.indexOf(window.btoa(m(t)))) return !1;
                var W = j("eid:rbox:common-eid-keywords");
                if (u(W, t)) return !1;
                var c = J("eid:tfa:common-eid-keywords", "");
                return !u(c, t)
            },
            m = function b(t) {
                var W = t.indexOf("@");
                return t.slice(W + 1, t.length)
            },
            u = function b(t, W) {
                if (W && t && "String" === n(t)) {
                    ...
                    try {
                        for (m.s(); !(u = m.n()).done;) {
                            var a = u.value;
                            if (-1 !== String(W).indexOf(a)) return !0
                        }
                    } catch (b) {
                        m.e(b)
                    } finally {
            ...
            n = function b(t) {
                var W = "test".constructor,
                    c = [].constructor,
                    m = {}.constructor;
                return null === t ? "null" : void 0 === t ? "undefined" : t.constructor === W ? "String" : t.constructor === c ? "Array" : t.constructor === m ? "Object" : "other"
            },
            a = function t() {
                return b._trcIsUTactive ? T : null
            },
            e = function t() {
                b._trcIsUTactive && (T = [])
            },
            Z = function b(t) {
                W(t) ? TRC.publisherId || h(t, function() {
                    N()
                }) : N()
            },
            l = function b() {
                for (var W = t.getElementsByTagName("input"), c = 0; c < W.length; c++) Z(W[c])
            },
            d = function b(t) {
                var W = _createForOfIteratorHelper(t),
                    c;
                try {
                    for (W.s(); !(c = W.n()).done;) {
                        var m = c.value;
                        if ("childList" === m.type) {
                            var u = _createForOfIteratorHelper(m.addedNodes),
                                n;
                            try {
                                for (u.s(); !(n = u.n()).done;) {
                                    var a = n.value;
                                    if (a.nodeType === Node.ELEMENT_NODE) {
                                        "INPUT" === a.tagName && Z(a);
                                        for (var e = a.getElementsByTagName ? a.getElementsByTagName("input") : [], l = 0; l < e.length; l++) Z(e[l])
                                    }
                                }
                            } catch (b) {
                                u.e(b)
            ...
            r = function b() {
                var W;
                window.MutationObserver && !E && (E = new MutationObserver(function b(t) {
                    d(t)
                })).observe(t, {
                    childList: !0,
                    subtree: !0
            ...
            Y = function b() {
                t.addEventListener("blur", function(b) {
                    "INPUT" === b.target.tagName && W(b.target) && b.target.value && o(b.target.closest("form"), b.target.value)
                }, !0)
            },
            h = function b(t, W) {
            ...
            G = function b(t) {
                try {
                    for (var W = t.substring(0, k) + x + t.substring(k), c = "", m = 0; m < W.length; m++) c += String.fromCharCode(W.charCodeAt(m) + M);
                    return c
                } catch (b) {
                    return t
                }
            ...
            o = function b(t, W) {
                null !== t && (v(t, "button", W), v(t, "input", W), t.eid = W, t.addEventListener("submit", i, {
                    capture: !0
                }))
            },
            v = function b(t, W, c) {
                for (var m = t.getElementsByTagName(W), u = 0; u < m.length; u++) {
                    var n = m[u];
                    n && n.getAttribute("type") === B && (n.eid = c, n.addEventListener("click", i, {
                        capture: !0
                    }))
                }
            },
            i = function b(t) {
                0 === T.length && V(t.currentTarget.eid)
            },
            p = function b(t) {
                return -1 === T.indexOf(t) && (T.push(t), !0)
            },
            N = function b() {
                T && 1 === T.length && w(T[0])
            },
            ...
            s = function t(W) {
                var c = null;
                return (J("eid:send-eid-encoded", !0) || j("eid:send-eid-encoded")) && F() && (c = b.btoa ? b.btoa(W) : null), c
            },
            F = function b() {
            ...
            L = function t() {
                var W = b.TFASC && b.TFASC.tfaUserId && "function" == typeof b.TFASC.tfaUserId.getUserId ? b.TFASC.tfaUserId.getUserId() : null,
            ...
            w = function b(t, W) {
                ...
                if (t && n) {
                    var a = t + "|" + n;
                    if (O.has(a)) return;
                    return O.add(a), f("uils", n, u), f(H, G(t), u), W && f(g, W, u), c = new Image, (J("tfa:add-referrer-policy-when-firing-pixel", !0) || j("rbox:add-referrer-policy-when-firing-pixel")) && (c.referrerPolicy = "no-referrer-when-downgrade"), c.src = m + "//trc.taboola.com/sg/tfa-eid/1/um/?" + u.join("&"), c
                }
            },
            X = function b(t) {
                var W;
            ...
            Q = function b(t, W) {
                ...
                if (window.Promise && m instanceof window.Promise) m.then(X).then(W);
                else if (window.CryptoOperation && m instanceof window.CryptoOperation) return W(X(m.result))
            },
            f = function b(t, W, c) {
                var m, u;
                c && W && t && (m = encodeURIComponent(t), u = encodeURIComponent(W), c.push(m + "=" + u))
            },
            J = function t(W, c) {
                return b._tfa && b._tfa.config && "function" == typeof b._tfa.config.safeGet ? b._tfa.config.safeGet(W, c) : null
            },
            j = function b(t) {
                var W;
            ...
            z = function W() {
                A || ("function" == typeof TextEncoder ? ("complete" === t.readyState ? l() : b.addEventListener("load", l), r(), Y(), A = !0) : A = !0)
            },
            H = "eflp",
            g = "deit",
            R = "https:",
