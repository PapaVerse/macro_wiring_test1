...
function serializeTextNode(n2, options) {
    ...
    if (isStyle && text) {
        try {
            if (n2.nextSibling || n2.previousSibling) {} else if ((_a2 = parent.sheet) == null ? void 0 : _a2.cssRules) {
        ...
        error(message, line, column, opts = {}) {
            ...
            if (origin) {
                result2 = new CssSyntaxError(
                    message,
                    origin.endLine === void 0 ? origin.line : {
            ...
            case EventType.Custom:
                {
                    this.replaceIds(
                        e2.data.payload,
                        iframeEl, ["id", "parentId", "previousId", "nextId"]
                    );
                    return e2;
                }
...
const blob = typeof self !== "undefined" && self.Blob && new Blob([jsContent], {
