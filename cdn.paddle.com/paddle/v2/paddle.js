! function(t, e) {
    ...
    return function() {
        ...
        var o, r, i, a, d, s, l, c, u = "multi-page",
            p = "express";
        ! function(t) {
        ...
        function(t) {
            t.PAYMENT_RECOVERY = "paymentRecovery", t.PAYMENT_RECOVERY_IN_APP = "paymentRecoveryInApp", t.TERM_OPTIMIZATION = "termOptimization", t.TERM_OPTIMIZATION_IN_APP = "termOptimizationInApp", t.CANCELLATION_FLOW = "cancellationFlow", t.PRE_PAYMENT_FAILURE_IN_APP = "prePaymentFailure"
        }(a || (a = {})),
        function(t) {
            t.error = "error", t.aborted = "aborted", t.choseToCancel = "chose_to_cancel", t.retained = "retained"
        }(d || (d = {}));
        var m, f, h, v = ((s = {})[o.PRODUCTION] = "https://cdn.paddle.com/paddle/v2/assets/css", s[o.SANDBOX] = "https://sandbox-cdn.paddle.com/paddle/v2/assets/css", s[o.STAGING] = "https://staging-cdn.paddle.dev/paddle/v2/assets/css", s[o.DEVELOPMENT] = "https://development-cdn.paddle.dev/paddle/v2/assets/css", s[o.LOCAL] = "assets/css", s),
            g = ((l = {})[o.PRODUCTION] = "https://cdn.paddle.com/paddle/v2/assets/images", l[o.SANDBOX] = "https://sandbox-cdn.paddle.com/paddle/v2/assets/images", l[o.STAGING] = "https://staging-cdn.paddle.dev/paddle/v2/assets/images", l[o.DEVELOPMENT] = "https://development-cdn.paddle.dev/paddle/v2/assets/images", l[o.LOCAL] = "assets/images", l),
            y = ((c = {})[o.PRODUCTION] = "https://cdn.paddle.com/paddle/v2/error.html", c[o.SANDBOX] = "https://sandbox-cdn.paddle.com/paddle/v2/error.html", c[o.STAGING] = "https://staging-cdn.paddle.dev/paddle/v2/error.html", c[o.DEVELOPMENT] = "https://development-cdn.paddle.dev/v2/paddle/error.html", c[o.LOCAL] = "http://localhost:8081/error.html", {
            ...
            A = {
                ...
                profitwellSnippetBase: "https://pw-staging-profitwell-public.paddle.dev/js/profitwell.js",
                apiBase: "https://staging-api.paddle.dev"
            },
            w = "https://www2.pw-staging.paddle-internal.com",
            b = {
            ...
            T = function() {
                ...
                return e.prototype.update = function(t) {
                    ...
                    for (var e in t) {
                        ...
                        this.options[e] = t[e], P.log("Set option '" + e + "' to '" + t[e] + "'.")
                    }
                    ...
                    if (!G(t) && !G(e)) throw new Error("[PADDLE BILLING] The option parameter 'seller' or 'token' must have a value.");
                    if (G(t) && G(e)) throw new Error("[PADDLE BILLING] The option parameter 'seller' or 'token' must have a value but not both.");
                    if (!G(e) && G(t) && (t !== parseInt("".concat(t), 10) || 0 === t)) throw new Error("[PADDLE BILLING] The option parameter 'seller' must be an integer.");
                    if (G(e) && "string" != typeof e && !G(t)) throw new Error("[PADDLE BILLING] The option parameter 'token' must be an string.");
                    if (1234567 === t) throw new Error("[PADDLE] You must specify a valid Paddle Seller ID for the 'seller' attribute within the Paddle.Initialize() method. The provided Vendor ID '1234567' is invalid and is used for example purposes. See: https://developer.paddle.com/build/checkout/build-overlay-checkout")
                }, e
            }(),
            O = new T,
            P = new(function() {
                ...
                return t.prototype.log = function(t, e, n) {
                    ...
                    O.debug && (e === i.LOG ? console.debug(o) : e === i.WARNING && console.warn(o)), n && console.warn(t)
                }, t
            }()),
            L = function() {
        ...
        function N() {
            var t = Q.get();
            if (!tt.loadedButtonStylesheet) {
                var e = document.getElementsByTagName("head")[0],
                    n = document.createElement("link");
                n.rel = "stylesheet", n.type = "text/css", n.href = function(t) {
                    var e = Object.values(o).indexOf(t) > -1 ? t : o.PRODUCTION;
                    return {
                        PADDLE_CSS_FILE: v[e] + "/paddle.css",
                        VENDORS_URL: "https://vendors.paddle.com/download/product/",
                        HEALTH_CHECK_GIF: g[e] + "/health-check.gif"
                    }
                }(t).PADDLE_CSS_FILE, n.media = "all", e.appendChild(n), tt.loadedButtonStylesheet = !0
            }
        }
        ...
        function k(t, e) {
            t.classList ? t.classList.add(e) : C(t, e) || (t.className += " " + e)
        }

        function R(t) {
            var e = t.getAttribute(h.DATA_DISCOUNT_ID),
                n = t.getAttribute(h.DATA_DISCOUNT_CODE),
                o = t.getAttribute(h.DATA_TRANSACTION_ID),
                r = t.getAttribute(h.DATA_ITEMS),
                i = t.getAttribute(h.DATA_CUSTOM_DATA),
                a = t.getAttribute(h.DATA_CUSTOMER_ID),
                d = t.getAttribute(h.DATA_CUSTOMER_EMAIL),
                s = t.getAttribute(h.DATA_BUSINESS_NAME),
                l = t.getAttribute(h.DATA_BUSINESS_ID),
                c = t.getAttribute(h.DATA_BUSINESS_TAX_ID),
                u = t.getAttribute(h.DATA_CUSTOMER_ADDRESS_FIRST_LINE),
                p = t.getAttribute(h.DATA_CUSTOMER_ADDRESS_CITY),
                m = t.getAttribute(h.DATA_CUSTOMER_ADDRESS_REGION),
                f = t.getAttribute(h.DATA_CUSTOMER_ADDRESS_ID),
                v = t.getAttribute(h.DATA_CUSTOMER_ADDRESS_COUNTRY_CODE),
                g = t.getAttribute(h.DATA_CUSTOMER_ADDRESS_POSTAL_CODE),
                y = t.getAttribute(h.DATA_LOCALE),
                _ = t.getAttribute(h.DATA_DISPLAY_MODE),
                A = t.getAttribute(h.DATA_THEME),
                w = t.getAttribute(h.DATA_VARIANT),
                b = t.getAttribute(h.DATA_SUCCESS_URL),
                E = t.getAttribute(h.DATA_ALLOW_LOGOUT),
                D = t.getAttribute(h.DATA_SHOW_ADD_DISCOUNTS),
                I = t.getAttribute(h.DATA_ALLOW_DISCOUNT_REMOVAL),
                T = t.getAttribute(h.DATA_SHOW_ADD_TAX_ID),
                O = t.getAttribute(h.DATA_ALLOWED_PAYMENT_METHODS),
                P = t.getAttribute(h.DATA_CUSTOMER_AUTH_TOKEN),
                N = t.getAttribute(h.DATA_SAVED_PAYMENT_METHOD_ID),
                S = t.getAttribute(h.DATA_UPSELL_TRANSACTION_ID),
                C = t.getAttribute(h.DATA_UPSELL_SHOW_SKIP_BUTTON),
                k = L(L(L(L(L(L(L({}, e && {
                    discountId: e
                }), n && {
                    discountCode: n
                    ...
                    savedPaymentMethodId: N
                });
            return (a || d) && (k.customer = L(L({}, a && {
                id: a
            }), d && {
                email: d
            })), (f || g || v || u || p || m) && (k.customer = k.customer || {}, k.customer && (k.customer.address = L(L(L(L(L(L({}, f && {
                id: f
            }), g && {
                postalCode: g
            }), v && {
                ...
                region: m
            }))), (l || s || c) && (k.customer = k.customer || {}, k.customer && (k.customer.business = L(L(L({}, l && {
                id: l
            }), s && {
                name: s
            }), c && {
                taxIdentifier: c
            }))), (y || A || _ || w || b || E || D || T || I) && (k.settings = L(L(L(L(L(L(L(L(L(L({}, y && {
                locale: y
            }), A && {
                theme: A
            }), _ && {
                ...
                showAddDiscounts: "true" === D
            }), I && {
                allowDiscountRemoval: "true" === I
            }), T && {
                showAddTaxId: "true" === T
            }), O && {
                allowedPaymentMethods: O
            })), S && (k.upsell = {
                transactionId: S,
                settings: {
                    showSkipButton: !C || "true" === C
                }
            }), k
        }
        var M = function() {
                var t = 0;
                S("paddle_button", (function(e) {
                    var n, o, a;
                    if ("v1" === (null !== (n = e.getAttribute(h.DATA_PADDLE_VERSION)) && void 0 !== n ? n : "v1")) {
                        ...
                        var s = R(e);
                        ! function(t, e) {
                            "none" !== e && (k(t, m.PADDLE_STYLED_BUTTON), e === r.GREEN ? k(t, m.GREEN) : e === r.LIGHT ? k(t, m.LIGHT) : e === r.DARK && k(t, m.DARK))
                        }(e, null === (a = null == s ? void 0 : s.settings) || void 0 === a ? void 0 : a.theme), e.setAttribute(h.DATA_INIT, "true"), e.addEventListener("click", (function(t) {
                            t.preventDefault();
                            var n = R(e);
                            ct.open(n)
                        })), t++, s.transactionId ? P.log("Loaded and initiated checkout button for Transaction ID: " + s.transactionId + " (Paddle Button #" + t + ")") : s.items ? P.log("Loaded and initiated checkout button for items: " + JSON.stringify(s.items) + " (Paddle Button #" + t + ")") : P.log("Initiated a checkout button without a transaction Id or price Id. (Paddle Button #" + t + ")", i.WARNING)
                    }
                }))
            },
            x = function() {
                                ...
                                i = {
                                        ...
                                        if (!n) {
                                            var e, a = arguments,
                                                ...
                                                l = void 0,
                                                c = void 0;
                                            for (t && (c = t, t = 0), d = 0, e = a.length; d < e; d++) s = a[d], "array" === (l = o.type(s)) ? i.done.apply(i, s) : "function" === l && r.push(s);
                                            c && i.resolveWith(c[0], c[1])
                                        }
                                        return this
                                    },
        ...
        function U(t) {
            ...
            n.setAttribute("style", "z-index:99998; display: block; position: fixed; height: 100%; width: 100%; top: 0px; left: 0px; right: 0px; bottom: 0px; margin: 0px; padding: 0px; background: rgba(0,0,0,0.38);"), n.setAttribute("class", m.PADDLE_LOADER);
            ...
            if (r.setAttribute("style", "border: 4px solid #f3f3f3;border-radius: 50%;border-top: 4px solid #ccc;width: 34px;height: 34px;-webkit-animation: rotate 1s ease-in-out infinite forwards;animation: rotate 1s ease-in-out infinite forwards;"), o.appendChild(r), n.appendChild(o), t) return function(t) {
        ...
        function H() {
            ...
            return !!window.isRetainApplePaySupported || !!t
        }
        ...
        function q(t, e) {
            ...
            var n, o = 0,
                r = 0;
            if (V(e))
                for (n = [], r = e.length; o < r; o++) n.push(q(t, e[o]));
            else
                for (var i in n = {}, e) Object.prototype.hasOwnProperty.call(e, i) && (n[t(i)] = q(t, e[i]));
            return n
        }
        ...
        var K = function(t, e) {
                var n = Q.defaults().checkoutFrontEndBase,
            ...
            z = function(t, e) {
                var n;
                t["paddlejs-version"] = tt.libraryVersion, t.checkoutInitiated = (new Date).getTime();
                var o = (null === (n = t.settings) || void 0 === n ? void 0 : n.sourcePage) || "",
                    r = K(JSON.stringify(q(W, t)), o),
                    i = e ? r + "&display_mode=inline" : r;
                i += "&apple_pay_enabled=".concat(H()), i += "&retain_enabled=".concat(window.isRetainEnabled || G(Y(f.RETAIN_IDENTIFIER)) || G(Y(f.SHORT_RETAIN_IDENTIFIER)));
                var a = Y(f.PADDLE_ACTION);
                return a === D && (i += "&action=".concat(a)), i
            };
        ...
        function J(t) {
            ...
            for (var r = 0; r < n.length; r++)
                if (t.indexOf(n[r]) > -1 || o.indexOf(n[r]) > -1) return e;
            return t
        }
        var X, Z = function() {
            ...
            $ = function() {
                function t() {
                    var t;
                    this.env = {
                        current: o.PRODUCTION,
                        defaults: (t = {}, t[o.LOCAL] = Z({}, y), t[o.DEVELOPMENT] = Z({}, _), t[o.SANDBOX] = Z({}, b), t[o.STAGING] = Z({}, A), t[o.PRODUCTION] = Z({}, E), t)
                    }
                }
                return t.prototype.detect = function() {
                    G(Y(f.PADDLE_ENVIRONMENT)) && "" !== Y(f.PADDLE_ENVIRONMENT) ? (P.log("Environment Detected: " + Y(f.PADDLE_ENVIRONMENT)), this.set(Y(f.PADDLE_ENVIRONMENT))) : P.log("Environment Detected: " + this.get())
                }, t.prototype.get = function() {
                    return this.env.current
                }, t.prototype.set = function(t) {
                    P.log("Changing environment to: " + t), this.env.current = t
        ...
        ! function(t) {
            t.CHECKOUT_CLOSE = "checkout.closed", t.CHECKOUT_COMPLETE = "checkout.completed", t.CHECKOUT_LOADED = "checkout.loaded", t.CHECKOUT_PING_SIZE = "checkout.ping.size", t.CHECKOUT_ITEMS_UPDATED = "checkout.items.updated", t.CHECKOUT_UPDATED = "checkout.updated", t.CHECKOUT_REMOVE_SPINNER = "checkout.removespinner", t.CHECKOUT_FAILED = "checkout.failed"
        }(X || (X = {}));
        var et, nt = "transaction-action";
        ! function(t) {
        ...
        var ot = function(t) {
                if ("string" == typeof t) try {
                    ...
                    return P.log("The value set at `settings.allowedPaymentMethods` is not a valid array and it will be ignored.", i.WARNING, !0), []
                }
                return t
            },
            rt = function() {
            ...
            dt = function() {
                ...
                return e.prototype.open = function(e) {
                    var n, o, r, a;
                    if (ut(), tt.completedSetup || P.log("[PADDLE BILLING] You haven't called Paddle.Initialize() - using Paddle.js without calling Paddle.Initialize() is unsupported and may result in unexpected behaviour. See: https://developer.paddle.com/build/checkout/build-overlay-checkout", i.WARNING, !0), "object" != typeof e) throw new Error(I);
                    st(e);
                    var d = lt(e);
                    P.log("[PADDLE BILLING] Creating checkout with attributes: " + JSON.stringify(d));
                    var s = {
                    ...
                    "loading" !== document.readyState ? pt(d, s, (null === (a = d.settings) || void 0 === a ? void 0 : a.displayMode) === t.INLINE) : document.addEventListener("DOMContentLoaded", (function() {
                        var e;
                        pt(d, s, (null === (e = d.settings) || void 0 === e ? void 0 : e.displayMode) === t.INLINE)
                    }))
                }, e.prototype.close = function() {
                    ht({
                        name: X.CHECKOUT_CLOSE,
                        data: {}
                    }), ut()
                    ...
                    null == e || e.postMessage({
                        action: nt,
                        eventName: X.CHECKOUT_ITEMS_UPDATED,
                        callbackData: t
                    }, "*")
                    ...
                    st(t);
                    var e = lt(t);
                    P.log("[PADDLE BILLING] Updating checkout with attributes: " + JSON.stringify(e));
                    var n = document.getElementsByName("paddle_frame")[0].contentWindow;
                    null == n || n.postMessage({
                        action: nt,
                        eventName: X.CHECKOUT_UPDATED,
                        callbackData: rt(rt({}, t), e.customData && {
            ...
            st = function(t) {
                ...
                try {
                    ...
                    var i = "string" == typeof t.items ? JSON.parse(t.items) : t.items,
                        ...
                        d = t.customer,
                        s = t.upsell;
                    if (G(a) && V(i) && i.length > 0) throw new Error("[PADDLE BILLING] Either specify transaction ID or items but not both.");
                    if (G(t.discountId) && G(t.discountCode)) throw new Error("[PADDLE BILLING] Either specify discount id or discount code but not both.");
                    if (d && B(d) && !G(null == d ? void 0 : d.id) && !G(null == d ? void 0 : d.email)) throw Error("[PADDLE BILLING] customer ID or email is required");
                    if (d && B(d) && G(null == d ? void 0 : d.id) && G(null == d ? void 0 : d.email)) throw Error("[PADDLE BILLING] Either specify customer ID only or customer details(email,marketingConsent,etc) but not both.");
                    if (s && B(s) && !G(s.transactionId)) throw Error("[PADDLE BILLING] Transaction ID is required for Upsell");
                    if (d && d.address && B(d) && B(d.address) && G(null === (n = d.address) || void 0 === n ? void 0 : n.id) && Object.keys(d.address).length > 1) throw Error("[PADDLE BILLING] Either specify customer address ID only or address details(postalCode,countryCode) but not both.");
                    if (d && d.business && B(d) && B(d.business) && G(null === (o = d.business) || void 0 === o ? void 0 : o.id) && Object.keys(d.business).length > 1) throw Error("[PADDLE BILLING] Either specify customer business ID only or business details(name,taxIdentifier) but not both.")
                } catch (t) {
                    throw new Error("".concat("[PADDLE BILLING] Checkout input failed validation : ").concat(t))
                }
            },
            lt = function(e) {
                var n, o, a, d, s, l, c, m, f, h, v, g, y, _, A, w, b, E, D, I, T, L, N, S, C, k, R, M, x, U, j, F, q, W, Y, K, z, X, Z = null !== (a = null !== (o = null === (n = e.settings) || void 0 === n ? void 0 : n.variant) && void 0 !== o ? o : O.variant) && void 0 !== a ? a : u,
                    $ = Z === p,
                    Q = e.settings || {},
                    tt = Q.allowLogout,
                    et = it(Q, ["allowLogout"]),
                    nt = rt(rt(rt(rt(rt(rt(rt(rt(rt({}, G(e.discountId) && {
                        ...
                        settings: rt(rt(rt(rt(rt(rt(rt(rt(rt(rt({}, et), ((null === (d = e.settings) || void 0 === d ? void 0 : d.successUrl) || O.successUrl) && {
                            successUrl: J((null === (s = e.settings) || void 0 === s ? void 0 : s.successUrl) || O.successUrl)
                        }), ((null === (l = e.settings) || void 0 === l ? void 0 : l.locale) || O.locale) && {
                            locale: (null === (c = e.settings) || void 0 === c ? void 0 : c.locale) || O.locale
                        }), ((null === (m = e.settings) || void 0 === m ? void 0 : m.frameTarget) || O.frameTarget) && {
                            frameTarget: (null === (f = e.settings) || void 0 === f ? void 0 : f.frameTarget) || O.frameTarget
                        }), ((null === (h = e.settings) || void 0 === h ? void 0 : h.frameStyle) || O.frameStyle) && {
                            frameStyle: (null === (v = e.settings) || void 0 === v ? void 0 : v.frameStyle) || O.frameStyle
                        }), ((null === (g = e.settings) || void 0 === g ? void 0 : g.frameInitialHeight) || O.frameInitialHeight) && {
                            frameInitialHeight: (null === (y = e.settings) || void 0 === y ? void 0 : y.frameInitialHeight) || O.frameInitialHeight
                        }), {
                            theme: (null === (_ = e.settings) || void 0 === _ ? void 0 : _.theme) || O.theme || r.LIGHT
                        }), !$ && {
                            allowLogout: null === (A = null != tt ? tt : O.allowLogout) || void 0 === A || A
                        }), {
                            showAddDiscounts: !$ && (null === (E = null !== (b = null === (w = e.settings) || void 0 === w ? void 0 : w.showAddDiscounts) && void 0 !== b ? b : O.showAddDiscounts) || void 0 === E || E),
                            allowDiscountRemoval: null === (T = null !== (I = null === (D = e.settings) || void 0 === D ? void 0 : D.allowDiscountRemoval) && void 0 !== I ? I : O.allowDiscountRemoval) || void 0 === T || T,
                            showAddTaxId: !$ && (null === (S = null !== (N = null === (L = e.settings) || void 0 === L ? void 0 : L.showAddTaxId) && void 0 !== N ? N : O.showAddTaxId) || void 0 === S || S),
                            variant: Z,
                            displayMode: (null !== (k = null === (C = e.settings) || void 0 === C ? void 0 : C.displayMode) && void 0 !== k ? k : O.displayMode) === t.INLINE ? t.INLINE : at
                        }), (null === (R = e.settings) || void 0 === R ? void 0 : R.allowedPaymentMethods) ? {
                            allowedPaymentMethods: null !== (x = ot(null === (M = e.settings) || void 0 === M ? void 0 : M.allowedPaymentMethods)) && void 0 !== x ? x : []
                        } : {})
                    }), !G(e.settings) && {
                        settings: rt(rt(rt(rt(rt(rt(rt(rt({
                            theme: O.theme || r.LIGHT
                        }, !$ && {
                            allowLogout: null === (U = O.allowLogout) || void 0 === U || U
                        }), {
                            showAddDiscounts: !$ && (null === (j = O.showAddDiscounts) || void 0 === j || j),
                            allowDiscountRemoval: null === (F = O.allowDiscountRemoval) || void 0 === F || F,
                            showAddTaxId: !$ && (null === (q = O.showAddTaxId) || void 0 === q || q),
                            displayMode: O.displayMode === t.INLINE ? t.INLINE : at,
                            variant: Z
                        }), O.locale && {
                            locale: O.locale
                        }), O.successUrl && {
                            successUrl: J(O.successUrl)
                        }), O.frameTarget && {
                            frameTarget: O.frameTarget
                        }), O.frameStyle && {
                            frameStyle: O.frameStyle
                        }), O.frameInitialHeight && {
                            frameInitialHeight: O.frameInitialHeight
                        }), O.allowedPaymentMethods && {
                            allowedPaymentMethods: O.allowedPaymentMethods
                        })
                    }), G(e.customerAuthToken) && {
                        customerAuthToken: e.customerAuthToken
                    }), G(e.savedPaymentMethodId) && {
                        savedPaymentMethodId: e.savedPaymentMethodId
                    }), G(e.upsell) && {
                        upsell: {
                            transactionId: null !== (Y = null === (W = e.upsell) || void 0 === W ? void 0 : W.transactionId) && void 0 !== Y ? Y : "",
                            settings: {
                                showSkipButton: null === (X = null === (z = null === (K = e.upsell) || void 0 === K ? void 0 : K.settings) || void 0 === z ? void 0 : z.showSkipButton) || void 0 === X || X
                            }
                        }
                    });
                if (e.settings && e.settings.successUrl && (O.successUrl = e.settings.successUrl), G(e.customData)) try {
                    var dt = "string" == typeof e.customData ? JSON.parse(e.customData) : e.customData;
                    if (!B(dt)) throw new Error("Invalid custom data");
                    nt.customData = JSON.stringify(dt)
                } catch (t) {
                    P.log("[PADDLE BILLING] The value set at customData is not a valid object and it will be ignored.", i.WARNING, !0)
                }
                if (G(e.items)) try {
                    var st = "string" == typeof e.items ? JSON.parse(e.items) : e.items;
                    if (!V(st)) throw new Error("Invalid items array");
                    nt.items = st.map((function(t) {
                        return t.quantity ? t : rt(rt({}, t), {
                            quantity: 1
                        })
                    }))
                } catch (t) {
                    P.log("[PADDLE BILLING] The value set at items is not a valid array and it will be ignored.", i.WARNING, !0)
                }
                return O.seller && (nt.sellerId = O.seller), O.token && (nt.clientToken = O.token), nt.applePayEnabled = H(), nt.settings && (nt.settings.sourcePage = window.location.href, nt.settings.referrer = function() {
                    try {
            ...
            ct = new dt,
            ut = function() {
                P.log("[PADDLE BILLING] Checkout frame/window has been closed."), j(), S(m.PADDLE_FRAME, (function(t) {
                    var e;
                    null === (e = t.parentNode) || void 0 === e || e.removeChild(t)
                })), void 0 === window.PaddleWindow || window.PaddleWindow.closed || window.PaddleWindow.close(), ct.isOpen = !1
            },
            pt = function(t, e, n) {
                var o, r, i, a, d = z(t, n);
                if (n || U(), window.PaddleFrame = document.createElement("iframe"), window.PaddleFrame.className = m.PADDLE_FRAME, window.PaddleFrame.name = "paddle_frame", window.PaddleFrame.frameBorder = "0", window.PaddleFrame.allowTransparency = "true", window.PaddleFrame.allow = "payment", n) {
                    window.PaddleFrame.classList.add(m.PADDLE_FRAME_INLINE);
                    var s = document.createElement("style");
                    s.type = "text/css", s.innerHTML = ".".concat(m.PADDLE_FRAME_INLINE, "::-webkit-scrollbar { display: none !important; }"), document.getElementsByTagName("head")[0].appendChild(s)
                } else window.PaddleFrame.classList.add(m.PADDLE_FRAME_OVERLAY);
        ...
        var ft = function(t) {
            var e, n;
            if ((null === (e = null == t ? void 0 : t.data) || void 0 === e ? void 0 : e.event_name) && [X.CHECKOUT_LOADED, X.CHECKOUT_FAILED].includes(t.data.event_name) && (ct.isOpen = !0), o = t.origin, /^https:\/\/[a-zA-Z0-9-_]+\.paddle\.(?:com|dev|local)$/g.test(o) && (!O.enableConcurrentVersions || ct.isOpen)) {
                var o, r = t.data;
                if (r.action === et.EVENT || r.action === et.CLOSE) switch (ht(mt({}, r.callback_data)), null === (n = r.event_name) || void 0 === n ? void 0 : n.toLowerCase()) {
                    case X.CHECKOUT_CLOSE:
                        ut();
                        break;
                    case X.CHECKOUT_REMOVE_SPINNER:
                    case X.CHECKOUT_LOADED:
                        j();
                        break;
                    case X.CHECKOUT_PING_SIZE:
                        ! function(t) {
                            if (t.callback_data && "" !== t.callback_data.height) {
                                var e = document.getElementsByClassName(m.PADDLE_FRAME_INLINE);
                                if (e.length > 0) {
                        ...
                        break;
                    case X.CHECKOUT_COMPLETE:
                        ! function() {
                            try {
                                var t = O.successUrl;
                                t && (ut(), setTimeout((function() {
        ...
        function ht(t) {
            "function" == typeof O.eventCallback && O.eventCallback(t)
        }
        var vt = function() {
        ...
        function yt() {
            var t;
            if (!(null === (t = window.profitwell) || void 0 === t ? void 0 : t.isLoaded)) {
                var e = Q.get();
                if (e !== o.SANDBOX) {
                    var n = function() {
                        var t = O.pwAuth,
                            e = O.token;
                        if (G(e)) return "paddletoken_".concat(e);
                        if (G(t) && "string" == typeof t) return t;
                        return null
                    }();
                    null !== n && (function(t, e) {
                        void 0 === e && (e = o.PRODUCTION);
                        ...
                        window.profitwell("start", n)
                    }(n, e), function(t) {
                        var e = document.createElement("script");
                        e.src = (n = t, Q.defaults().profitwellSnippetBase + "?auth=" + n), document.getElementsByTagName("head")[0].appendChild(e);
                        var n
                    }(n))
                }
            }
        ...
        function _t(t) {
            window.profitwell.apply(window, gt(["cq_demo"], function(t) {
                switch (t) {
                    ...
                    case a.PRE_PAYMENT_FAILURE_IN_APP:
                        return ["card_watch"];
                    default:
        ...
        function Tt(t) {
            ...
            return {
                ...
                unitPriceOverrides: null === (n = t.unit_price_overrides) || void 0 === n ? void 0 : n.map(bt),
                importMeta: t.import_meta ? {
                    externalId: null !== (o = t.import_meta.external_id) && void 0 !== o ? o : null,
                    importedFrom: t.import_meta.imported_from
                } : null
            }
        }
        ...
        function Ot(t) {
            ...
            return {
                ...
                product: Et(t.product),
                discounts: null === (e = t.discounts) || void 0 === e ? void 0 : e.map(It)
            }
        }
        ...
        var Nt = function(t, e, n, o) {
            ...
            Ct = function(t) {
                return Nt(void 0, void 0, void 0, (function() {
                    ...
                    return St(this, (function(s) {
                        switch (s.label) {
                            case 0:
                                if (!O.token) throw new Error("[PADDLE] token is required to use Paddle.PricePreview()");
                                if (!(B(t) && (c = t.items, c && c.length && c.every((function(t) {
                                ...
                                e = {
                                    items: (l = t).items.map(At),
                                    customer_id: l.customerId,
                                    address_id: l.addressId,
                                    business_id: l.businessId,
                                    currency_code: l.currencyCode,
                                    discount_id: l.discountId,
                                    address: wt(l),
                                    customer_ip_address: l.customerIpAddress
                            ...
                            case 1:
                                return s.trys.push([1, 3, , 4]), a = Q.defaults().apiBase, [4, fetch("".concat(a, "/pricing-preview"), o)];
                            case 2:
                                return r = s.sent(), [3, 4];
                            case 3:
                                ...
                                return r.ok ? (d = function(t) {
                                    ...
                                    return {
                                        data: {
                                            ...
                                            address: Pt(t.data.address),
                                            customerIpAddress: t.data.customer_ip_address,
                                            discountId: t.data.discount_id,
                                            details: {
                                                lineItems: null === (e = t.data.details.line_items) || void 0 === e ? void 0 : e.map(Ot)
                                            },
            ...
            kt = new(function() {
                ...
                return t.prototype.demo = function(t) {
                    if (!G(O.token) && !G(O.pwAuth)) throw new Error("[PADDLE] Options.token or Options.pwAuth must be set for Paddle.Retain.demo()");
                    _t(t.feature)
                }, t.prototype.initCancellationFlow = function(t) {
                    if (!G(O.token) && !G(O.pwAuth)) throw new Error("[PADDLE] Options.token or Options.pwAuth must be set for Paddle.Retain.initCancellationFlow()");
                    if (!G(O.pwCustomer) && !(null == t ? void 0 : t.subscriptionId)) throw new Error("[PADDLE] pwCustomer or subscriptionId required to use Paddle.Retain.initCancellationFlow");
                    return G(e = null == t ? void 0 : t.subscriptionId) ? window.profitwell("init_cancellation_flow", {
                        subscription_id: e
        ...
        function Ht(t) {
            return Bt(this, void 0, void 0, (function() {
                ...
                return Gt(this, (function(s) {
                    switch (s.label) {
                        case 0:
                            if (!O.token) throw new Error("[PADDLE] token is required to use Paddle.TransactionPreview()");
                            if (!(B(t) && (c = t.items, c && c.length && c.every((function(t) {
                        ...
                        case 1:
                            return s.trys.push([1, 3, , 4]), a = Q.defaults().apiBase, [4, fetch("".concat(a, "/transactions/preview"), o)];
                        case 2:
                            return r = s.sent(), [3, 4];
                        case 3:
                            return s.sent(), [2, Promise.reject({
                            ...
                            return r.ok ? (d = function(t) {
                                return {
                                    data: {
                                        ...
                                        details: {
                                            taxRatesUsed: t.data.details.tax_rates_used.map(xt),
                                            ...
                                            lineItems: t.data.details.line_items.map(Ut)
                                        },
                                        items: t.data.items.map(jt),
                                        availablePaymentMethods: t.data.available_payment_methods
                                    },
                                    meta: {
                                        requestId: t.meta.request_id
        ...
        var Ft = new(function() {
            function t(t) {
                tt.libraryVersion = t, this.Status = {
                    libraryVersion: t
                    ...
                    updateCheckout: function(t) {
                        return ct.updateCheckout(t)
                    },
                    updateItems: function(t) {
                        return ct.updateItems(t)
                    }
                }, this.Retain = {
                    demo: function(t) {
                        return kt.demo(t)
                    ...
                    initCancellationFlow: function(t) {
                        return kt.initCancellationFlow(t)
                    }
                }, this.Environment = {
                    detect: function() {
                        return Q.detect()
                ...
                }, this.PricePreview = Ct, this.TransactionPreview = Ht, this.Spinner = {
                    show: U,
                    hide: j
                }, this.Status = {
                    libraryVersion: tt.libraryVersion
                }
            }
            return t.prototype.Options = function(t) {
                ...
                var e;
                O.update(t), t.pwCustomer && (e = t.pwCustomer, window.profitwell && e && (G(e.id) && window.profitwell("user_id", e.id), G(e.email) && window.profitwell("user_email", e.email)))
            }, t.prototype._setup = function(t) {
                if (tt.completedSetup) P.log("[PADDLE BILLING] Cannot call Paddle.Initialize() more than once per page, the call was ignored.", i.WARNING);
                else {
                    if (N(), x(M), tt.completedSetup = !0, P.log("[PADDLE BILLING] Completed library setup."), window.addEventListener("message", ft, !1), Q.detect(), !G(t.seller) && !G(t.token)) throw new Error("[PADDLE BILLING] You must specify your Paddle Seller ID or token within the Paddle.Initialize() method. See: https://developer.paddle.com/build/checkout/build-overlay-checkout");
                    O.set(t),
                        function(t) {
                            if (void 0 === t && (t = !1), G(Y(f.PADDLE_TRANSACTION))) {
                                U();
                                var e = Y(f.PADDLE_TRANSACTION);
                                t && ct.open({
                                    transactionId: e
                                })
                            }
                        }(G(O.seller) || G(O.token)), yt()
                }
            }, t
        }())("2.9.1");
        return n
