...
const mi = /^[$_\p{ID_Start}][$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
    gi = /^[$_\p{ID_Start}][-$_\u{200C}\u{200D}\p{ID_Continue}]*$/u,
    di = {};

function ct(e, t) {
    return (di.jsx ? gi : mi).test(e)
}
const yi = /[ \t\n\f\r]/g;
...
class Hn extends ee {
    constructor(t, n, r, i) {
        let o = -1;
        if (super(t, n), ht(this, "space", i), typeof r == "number")
            for (; ++o < pn.length;) {
                const l = pn[o];
                ht(this, pn[o], (r & Ln[l]) === Ln[l])
            }
    }
}
...
function Ii(e, t) {
    ...
    if (n.length > 4 && n.slice(0, 4) === "data" && Ei.test(t)) {
        if (t.charAt(4) === "-") {
            const o = t.slice(5).replace(pt, Ti);
            r = "data" + o.charAt(0).toUpperCase() + o.slice(1)
        } else {
            const o = t.slice(4);
            if (!pt.test(o)) {
                let l = o.replace(Ci, Ai);
...
const Pi = er([nr, bi, ir, lr, or], "html"),
    Un = er([nr, wi, ir, lr, or], "svg");
...
`,
    ...
    mn = function(x, E) {
        ...
        function C(z) {
            var T = z.match(t);
            T && (y += T.length);
            var L = z.lastIndexOf(u);
            I = ~L ? z.length - L : I + z.length
        }
        ...
        function R() {
            ...
            return function(T) {
                return T.position = new _(z), U(), T
            }
        }

        function _(z) {
            this.start = z, this.end = {
                line: y,
                column: I
        ...
        function w(z) {
            var T = new Error(E.source + ":" + y + ":" + I + ": " + z);
            if (T.reason = z, T.filename = E.source, T.line = y, T.column = I, T.source = x, !E.silent) throw T
        }
        ...
        function M(z) {
            ...
            if (T) {
                var L = T[0];
                return C(L), x = x.slice(L.length), T
            }
        }
        ...
        function k() {
            ...
            if (!(s != x.charAt(0) || f != x.charAt(1))) {
                for (var T = 2; c != x.charAt(T) && (f != x.charAt(T) || s != x.charAt(T + 1));) ++T;
                if (T += 2, c === x.charAt(T - 1)) return w("End of comment missing");
                var L = x.slice(2, T - 2);
                return I += 2, C(L), x = x.slice(T), I += 2, z({
                    type: p,
                    comment: L
                })
            }
        ...
        function P() {
            var z = R(),
                T = M(r);
            if (T) {
                if (k(), !M(i)) return w("property missing ':'");
                var L = M(o),
                    Y = z({
                        type: h,
                        property: d(T[0].replace(e, c)),
                        value: L ? d(L[0].replace(e, c)) : c
                    });
                return M(l), Y
            }
        }
        ...
        function v() {
            var z = [];
            H(z);
            for (var T; T = P();) T !== !1 && (z.push(T), H(z));
            return z
        }
        return U(), v()
    };
...
function Li() {
    if (dt) return Ne;
    dt = 1, Object.defineProperty(Ne, "__esModule", {
        value: !0
    }), Ne.camelCase = void 0;
    var e = /^--[a-zA-Z0-9_-]+$/,
        t = /-([a-z])/g,
...
function Ue(e) {
    return !e || typeof e != "object" ? "" : "position" in e || "type" in e ? kt(e.position) : "start" in e || "end" in e ? kt(e) : "line" in e || "column" in e ? Fn(e) : ""
}
...
const Vn = {}.hasOwnProperty,
    Mi = new Map,
    Ni = /[A-Z]/g,
    Bi = new Set(["table", "tbody", "thead", "tfoot", "tr"]),
    ji = new Set(["td", "th"]),
...
function cr(e, t, n) {
    ...
    if (t.type === "mdxFlowExpression" || t.type === "mdxTextExpression") return qi(e, t);
    if (t.type === "mdxJsxFlowElement" || t.type === "mdxJsxTextElement") return $i(e, t, n);
    if (t.type === "mdxjsEsm") return Vi(e, t);
    if (t.type === "root") return Wi(e, t, n);
    if (t.type === "text") return Yi(e, t)
}
...
function Ui(e, t, n) {
    ...
    const o = hr(e, t.tagName, !1),
        l = Gi(e, t);
    let a = Wn(e, t);
    return Bi.has(t.tagName) && (a = a.filter(function(u) {
        return typeof u == "string" ? !ki(u) : !0
    })), fr(e, l, o, t), $n(l, a), e.ancestors.pop(), e.schema = r, e.create(t, o, l, n)
}
...
function $i(e, t, n) {
    ...
    const o = t.name === null ? e.Fragment : hr(e, t.name, !0),
        l = Ki(e, t),
        a = Wn(e, t);
    return fr(e, l, o, t), $n(l, a), e.ancestors.pop(), e.schema = r, e.create(t, o, l, n)
}

function Wi(e, t, n) {
    const r = {};
    return $n(r, Wn(e, t)), e.create(t, e.Fragment, r, n)
}
...
function Gi(e, t) {
    ...
    for (i in t.properties)
        if (i !== "children" && Vn.call(t.properties, i)) {
            const o = Ji(e, i, t.properties[i]);
            if (o) {
                const [l, a] = o;
...
function Ji(e, t, n) {
    const r = Ii(e.schema, t);
    if (!(n == null || typeof n == "number" && Number.isNaN(n))) {
        if (Array.isArray(n) && (n = r.commaSeparated ? pi(n) : vi(n)), r.property === "style") {
            let i = typeof n == "object" ? n : Zi(e, String(n));
            return e.stylePropertyNameCase === "css" && (i = el(i)), ["style", i]
        }
        return [e.elementAttributeNameCase === "react" && r.space ? Si[r.property] || r.property : r.attribute, n]
    }
}
...
function hr(e, t, n) {
    ...
    if (r.type === "Literal") {
        const i = r.value;
        return Vn.call(e.components, i) ? e.components[i] : i
    }
...
function el(e) {
    const t = {};
    let n;
    for (n in e) Vn.call(e, n) && (t[nl(n)] = e[n]);
    return t
}

function nl(e) {
    let t = e.replace(Ni, tl);
...
const wt = document.createElement("i");

function Xn(e) {
    const t = "&" + e + ";";
    wt.innerHTML = t;
    const n = wt.textContent;
...
function ll(e, t) {
    let n;
    for (n in t) {
        const i = (St.call(e, n) ? e[n] : void 0) || (e[n] = {}),
            o = t[n];
        let l;
        if (o)
            for (l in o) {
...
function Re(e) {
    ...
    for (; ++n < e.length;) {
        ...
        let l = "";
        if (o === 37 && G(e.charCodeAt(n + 1)) && G(e.charCodeAt(n + 2))) i = 2;
...
function fl(e) {
    ...
    function r(a) {
        ...
        return e.enter("lineEnding"), e.consume(a), e.exit("lineEnding"), j(e, t, "linePrefix")
    }
...
function pl(e) {
    ...
    function a(C) {
        if (r < n.length) {
            const R = n[r];
            return t.containerState = R[1], e.attempt(R[0].continuation, u, s)(C)
        }
        return s(C)
    }
    ...
    function u(C) {
        if (r++, t.containerState._closeFlow) {
            ...
            y(r);
            let M = R;
            for (; M < t.events.length;) t.events[M][1].end = { ...w
            }, M++;
            return re(t.events, _ + 1, 0, t.events.slice(R)), t.events.length = M, s(C)
        }
        return a(C)
    }
    ...
    function s(C) {
        ...
        return t.containerState = {}, e.check(Ct, f, c)(C)
    }
    ...
    function p(C) {
        return t.containerState = {}, e.attempt(Ct, h, d)(C)
    }
    ...
    function x(C) {
        ...
        return D(C) ? (e.consume(C), E(e.exit("chunkFlow")), r = 0, t.interrupt = void 0, a) : (e.consume(C), x)
    }

    function E(C, R) {
        const _ = t.sliceStream(C);
        if (R && _.push(null), C.previous = o, o && (o.next = C), o = C, i.defineSkip(C.start), i.write(_), t.parser.lazy[C.start.line]) {
            let w = i.events.length;
            for (; w--;)
                if (i.events[w][1].start.offset < l && (!i.events[w][1].end || i.events[w][1].end.offset > l)) return;
            ...
            for (y(r), w = M; w < t.events.length;) t.events[w][1].end = { ...k
            }, w++;
            re(t.events, U + 1, 0, t.events.slice(M)), t.events.length = w
        }
    }
            ...
            for (r = n; r--;)
                if (e[r][0] === "exit" && e[r][1].type === "attentionSequence" && e[r][1]._open && t.sliceSerialize(e[r][1]).charCodeAt(0) === t.sliceSerialize(e[n][1]).charCodeAt(0)) {
                    ...
                    Et(c, -u), Et(p, u), l = {
                        ...
                        ["exit", l, t],
                        ["enter", o, t]
                    ]), s = ie(s, un(t.parser.constructs.insideSpan.null, e.slice(r + 1, n), t)), s = ie(s, [
                        ["exit", o, t],
                        ["enter", a, t],
                        ["exit", a, t],
                        ["exit", i, t]
...
function dl(e, t) {
    ...
    function a(u) {
        ...
        const s = e.exit("attentionSequence"),
            f = Le(u),
            c = !f || f === 2 && i || n.includes(u),
            p = !i || i === 2 && f || n.includes(r);
...
function kl(e, t, n) {
    ...
    function s(h) {
        return h === 64 ? (e.consume(h), f) : al(h) ? (e.consume(h), s) : n(h)
    }
...
function El(e, t, n) {
    ...
    function s(c) {
        return c === 88 || c === 120 ? (e.enter("characterReferenceMarkerHexadecimal"), e.consume(c), e.exit("characterReferenceMarkerHexadecimal"), e.enter("characterReferenceValue"), o = 6, l = ul, f) : (e.enter("characterReferenceValue"), o = 7, l = Rn, f(c))
    }

    function f(c) {
        if (c === 59 && i) {
            const p = e.exit("characterReferenceValue");
            return l === G && !Xn(r.sliceSerialize(p)) ? n(c) : (e.enter("characterReferenceMarker"), e.consume(c), e.exit("characterReferenceMarker"), e.exit("characterReference"), t)
        }
...
function Il(e, t, n) {
    ...
    function c(w) {
        return w === null || D(w) ? (e.exit("codeFencedFence"), r.interrupt ? t(w) : e.check(It, x, R)(w)) : (e.enter("codeFencedFenceInfo"), e.enter("chunkString", {
            contentType: "string"
        }), p(w))
    }

    function p(w) {
        return w === null || D(w) ? (e.exit("chunkString"), e.exit("codeFencedFenceInfo"), c(w)) : N(w) ? (e.exit("chunkString"), e.exit("codeFencedFenceInfo"), j(e, h, "whitespace")(w)) : w === 96 && w === a ? n(w) : (e.consume(w), p)
    }
    ...
    function d(w) {
        return w === null || D(w) ? (e.exit("chunkString"), e.exit("codeFencedFenceMeta"), c(w)) : w === 96 && w === a ? n(w) : (e.consume(w), d)
    }

    function x(w) {
        return e.attempt(i, R, E)(w)
    }
    ...
    function y(w) {
        return o > 0 && N(w) ? j(e, I, "linePrefix", o + 1)(w) : I(w)
    }

    function I(w) {
        return w === null || D(w) ? e.check(It, x, R)(w) : (e.enter("codeFlowValue"), C(w))
    }

    function C(w) {
        return w === null || D(w) ? (e.exit("codeFlowValue"), I(w)) : (e.consume(w), C)
    }
    ...
    function _(w, M, U) {
        ...
        function P(L) {
            return w.enter("codeFencedFence"), N(L) ? j(w, v, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(L) : v(L)
        }

        function v(L) {
            return L === a ? (w.enter("codeFencedFenceSequence"), z(L)) : U(L)
        }

        function z(L) {
            return L === a ? (H++, w.consume(L), z) : H >= l ? (w.exit("codeFencedFenceSequence"), N(L) ? j(w, T, "whitespace")(L) : T(L)) : U(L)
        }

        function T(L) {
            return L === null || D(L) ? (w.exit("codeFencedFence"), M(L)) : U(L)
        }
    }
}
...
function Pl(e, t, n) {
    ...
    function i(s) {
        return e.enter("codeIndented"), j(e, o, "linePrefix", 5)(s)
    }
    ...
    function l(s) {
        return s === null ? u(s) : D(s) ? e.attempt(Tl, l, u)(s) : (e.enter("codeFlowValue"), a(s))
    }
...
function vl(e, t, n) {
    ...
    function i(l) {
        return r.parser.lazy[r.now().line] ? n(l) : D(l) ? (e.enter("lineEnding"), e.consume(l), e.exit("lineEnding"), i) : j(e, o, "linePrefix", 5)(l)
    }
...
function Fl(e, t, n) {
    ...
    function u(c) {
        return c === null ? n(c) : c === 32 ? (e.enter("space"), e.consume(c), e.exit("space"), u) : c === 96 ? (o = e.enter("codeTextSequence"), i = 0, f(c)) : D(c) ? (e.enter("lineEnding"), e.consume(c), e.exit("lineEnding"), u) : (e.enter("codeTextData"), s(c))
    }

    function s(c) {
        return c === null || c === 32 || c === 96 || D(c) ? (e.exit("codeTextData"), u(c)) : (e.consume(c), s)
    }
...
function xr(e) {
    ...
    for (; ++n < f.length;) {
        ...
        if (r[0] === "enter") r[1].contentType && (Object.assign(t, _l(f, n)), n = t[n], s = !0);
        else if (r[1]._container) {
            for (o = n, i = void 0; o--;)
                if (l = f.get(o), l[1].type === "lineEnding" || l[1].type === "lineEndingBlank") l[0] === "enter" && (i && (f.get(i)[1].type = "lineEndingBlank"), l[1].type = "lineEnding", i = o);
                else if (!(l[1].type === "linePrefix" || l[1].type === "listItemIndent")) break;
            i && (r[1].end = { ...f.get(i)[1].start
...
function _l(e, t) {
    ...
    for (h = n; ++p < a.length;) a[p][0] === "exit" && a[p - 1][0] === "enter" && a[p][1].type === a[p - 1][1].type && a[p][1].start.line !== a[p][1].end.line && (x = p + 1, E.push(x), h._tokenizer = void 0, h.previous = void 0, h = h.next);
    for (l.events = [], h ? (h._tokenizer = void 0, h.previous = void 0) : E.pop(), p = E.length; p--;) {
        const y = a.slice(E[p], E[p + 1]),
            I = o.pop();
        u.push([I, I + y.length - 1]), e.splice(I, 2, y)
    }
    for (u.reverse(), p = -1; ++p < u.length;) s[d + u[p][0]] = d + u[p][1], d += u[p][1] - u[p][0] - 1;
    return s
}
const Ol = {
        resolve: Nl,
...
function Bl(e, t) {
    ...
    function i(a) {
        return a === null ? o(a) : D(a) ? e.check(Ml, l, o)(a) : (e.consume(a), i)
    }
...
function br(e, t, n, r, i, o, l, a, u) {
    ...
    function h(y) {
        return y === 62 ? (e.exit("chunkString"), e.exit(a), p(y)) : y === null || y === 60 || D(y) ? n(y) : (e.consume(y), y === 92 ? d : h)
    }
    ...
    function x(y) {
        return !f && (y === null || y === 41 || V(y)) ? (e.exit("chunkString"), e.exit(a), e.exit(l), e.exit(r), t(y)) : f < s && y === 40 ? (e.consume(y), f++, x) : y === 41 ? (e.consume(y), f--, x) : y === null || y === 32 || y === 40 || tn(y) ? n(y) : (e.consume(y), y === 92 ? E : x)
    }
...
function wr(e, t, n, r, i, o) {
    ...
    function f(h) {
        return a > 999 || h === null || h === 91 || h === 93 && !u || h === 94 && !a && "_hiddenFootnoteSupport" in l.parser.constructs ? n(h) : h === 93 ? (e.exit(o), e.enter(i), e.consume(h), e.exit(i), e.exit(r), t) : D(h) ? (e.enter("lineEnding"), e.consume(h), e.exit("lineEnding"), f) : (e.enter("chunkString", {
            contentType: "string"
        }), c(h))
    }

    function c(h) {
        return h === null || h === 91 || h === 93 || D(h) || a++ > 999 ? (e.exit("chunkString"), f(h)) : (e.consume(h), u || (u = !N(h)), h === 92 ? p : c)
    }
...
function Sr(e, t, n, r, i, o) {
    ...
    function s(p) {
        return p === l ? (e.exit(o), u(l)) : p === null ? n(p) : D(p) ? (e.enter("lineEnding"), e.consume(p), e.exit("lineEnding"), j(e, s, "linePrefix")) : (e.enter("chunkString", {
            contentType: "string"
        }), f(p))
    }

    function f(p) {
        return p === l || p === null || D(p) ? (e.exit("chunkString"), s(p)) : (e.consume(p), p === 92 ? c : f)
    }
...
function ql(e, t, n) {
    ...
    function l(h) {
        return wr.call(r, e, a, n, "definitionLabel", "definitionLabelMarker", "definitionLabelString")(h)
    }
    ...
    function u(h) {
        return V(h) ? qe(e, s)(h) : s(h)
    }

    function s(h) {
        return br(e, f, n, "definitionDestination", "definitionDestinationLiteral", "definitionDestinationLiteralMarker", "definitionDestinationRaw", "definitionDestinationString")(h)
    }

    function f(h) {
        return e.attempt(Ul, c, c)(h)
    }
...
function Vl(e, t, n) {
    ...
    function r(a) {
        return V(a) ? qe(e, i)(a) : n(a)
    }

    function i(a) {
        return Sr(e, o, n, "definitionTitle", "definitionTitleMarker", "definitionTitleString")(a)
    }
...
function no(e, t, n) {
    ...
    function c(g) {
        return g === 33 ? (e.consume(g), p) : g === 47 ? (e.consume(g), o = !0, x) : g === 63 ? (e.consume(g), i = 3, r.interrupt ? t : m) : J(g) ? (e.consume(g), l = String.fromCharCode(g), E) : n(g)
    }
    ...
    function d(g) {
        const ae = "CDATA[";
        return g === ae.charCodeAt(a++) ? (e.consume(g), a === ae.length ? r.interrupt ? t : v : d) : n(g)
    }
    ...
    function E(g) {
        if (g === null || g === 47 || g === 62 || V(g)) {
            const ae = g === 47,
                be = l.toLowerCase();
            return !ae && !o && Tt.includes(be) ? (i = 1, r.interrupt ? t(g) : v(g)) : Gl.includes(l.toLowerCase()) ? (i = 6, ae ? (e.consume(g), y) : r.interrupt ? t(g) : v(g)) : (i = 7, r.interrupt && !r.parser.lazy[r.now().line] ? n(g) : o ? I(g) : C(g))
        }
        return g === 45 || G(g) ? (e.consume(g), l += String.fromCharCode(g), E) : n(g)
    }
    ...
    function C(g) {
        return g === 47 ? (e.consume(g), k) : g === 58 || g === 95 || J(g) ? (e.consume(g), R) : N(g) ? (e.consume(g), C) : k(g)
    }

    function R(g) {
        return g === 45 || g === 46 || g === 58 || g === 95 || G(g) ? (e.consume(g), R) : _(g)
    }

    function _(g) {
        return g === 61 ? (e.consume(g), w) : N(g) ? (e.consume(g), _) : C(g)
    }

    function w(g) {
        return g === null || g === 60 || g === 61 || g === 62 || g === 96 ? n(g) : g === 34 || g === 39 ? (e.consume(g), u = g, M) : N(g) ? (e.consume(g), w) : U(g)
    }

    function M(g) {
        return g === u ? (e.consume(g), u = null, H) : g === null || D(g) ? n(g) : (e.consume(g), M)
    }

    function U(g) {
        return g === null || g === 34 || g === 39 || g === 47 || g === 60 || g === 61 || g === 62 || g === 96 || V(g) ? _(g) : (e.consume(g), U)
    }
    ...
    function v(g) {
        return g === 45 && i === 2 ? (e.consume(g), Y) : g === 60 && i === 1 ? (e.consume(g), X) : g === 62 && i === 4 ? (e.consume(g), oe) : g === 63 && i === 3 ? (e.consume(g), m) : g === 93 && i === 5 ? (e.consume(g), he) : D(g) && (i === 6 || i === 7) ? (e.exit("htmlFlowData"), e.check(Jl, pe, z)(g)) : g === null || D(g) ? (e.exit("htmlFlowData"), z(g)) : (e.consume(g), v)
    }

    function z(g) {
        return e.check(Zl, T, pe)(g)
    }
    ...
    function L(g) {
        return g === null || D(g) ? z(g) : (e.enter("htmlFlowData"), v(g))
    }
    ...
    function X(g) {
        return g === 47 ? (e.consume(g), l = "", le) : v(g)
    }

    function le(g) {
        if (g === 62) {
            const ae = l.toLowerCase();
            return Tt.includes(ae) ? (e.consume(g), oe) : v(g)
        }
        return J(g) && l.length < 8 ? (e.consume(g), l += String.fromCharCode(g), le) : v(g)
    }
    ...
    function m(g) {
        return g === 62 ? (e.consume(g), oe) : g === 45 && i === 2 ? (e.consume(g), m) : v(g)
    }
...
function to(e, t, n) {
    ...
    function i(l) {
        return D(l) ? (e.enter("lineEnding"), e.consume(l), e.exit("lineEnding"), o) : n(l)
    }
...
function ro(e, t, n) {
    ...
    function r(i) {
        return e.enter("lineEnding"), e.consume(i), e.exit("lineEnding"), e.attempt(Xe, t, n)
    }
}
const io = {
    name: "htmlText",
...
function lo(e, t, n) {
    ...
    function u(m) {
        return m === 33 ? (e.consume(m), s) : m === 47 ? (e.consume(m), _) : m === 63 ? (e.consume(m), C) : J(m) ? (e.consume(m), U) : n(m)
    }
    ...
    function c(m) {
        return m === null ? n(m) : m === 45 ? (e.consume(m), p) : D(m) ? (l = c, X(m)) : (e.consume(m), c)
    }
    ...
    function x(m) {
        return m === null ? n(m) : m === 93 ? (e.consume(m), E) : D(m) ? (l = x, X(m)) : (e.consume(m), x)
    }
    ...
    function y(m) {
        return m === 62 ? Y(m) : m === 93 ? (e.consume(m), y) : x(m)
    }

    function I(m) {
        return m === null || m === 62 ? Y(m) : D(m) ? (l = I, X(m)) : (e.consume(m), I)
    }

    function C(m) {
        return m === null ? n(m) : m === 63 ? (e.consume(m), R) : D(m) ? (l = C, X(m)) : (e.consume(m), C)
    }
    ...
    function M(m) {
        return D(m) ? (l = M, X(m)) : N(m) ? (e.consume(m), M) : Y(m)
    }

    function U(m) {
        return m === 45 || G(m) ? (e.consume(m), U) : m === 47 || m === 62 || V(m) ? H(m) : n(m)
    }

    function H(m) {
        return m === 47 ? (e.consume(m), Y) : m === 58 || m === 95 || J(m) ? (e.consume(m), k) : D(m) ? (l = H, X(m)) : N(m) ? (e.consume(m), H) : Y(m)
    }

    function k(m) {
        return m === 45 || m === 46 || m === 58 || m === 95 || G(m) ? (e.consume(m), k) : P(m)
    }

    function P(m) {
        return m === 61 ? (e.consume(m), v) : D(m) ? (l = P, X(m)) : N(m) ? (e.consume(m), P) : H(m)
    }

    function v(m) {
        return m === null || m === 60 || m === 61 || m === 62 || m === 96 ? n(m) : m === 34 || m === 39 ? (e.consume(m), i = m, z) : D(m) ? (l = v, X(m)) : N(m) ? (e.consume(m), v) : (e.consume(m), T)
    }

    function z(m) {
        return m === i ? (e.consume(m), i = void 0, L) : m === null ? n(m) : D(m) ? (l = z, X(m)) : (e.consume(m), z)
    }
...
function co(e, t) {
    ...
    return a = [
        ...
        ["enter", f, t]
    ]), a = ie(a, un(t.parser.constructs.insideSpan.null, e.slice(o + r + 4, l - 3), t)), a = ie(a, [
        ["exit", f, t], e[l - 2], e[l - 1],
        ["exit", s, t]
...
function fo(e, t, n) {
    ...
    function u(p) {
        return p === 40 ? e.attempt(oo, f, l ? f : c)(p) : p === 91 ? e.attempt(ao, f, l ? s : c)(p) : l ? f(p) : c(p)
    }

    function s(p) {
        return e.attempt(uo, f, c)(p)
    }
...
function ho(e, t, n) {
    ...
    function i(c) {
        return V(c) ? qe(e, o)(c) : o(c)
    }

    function o(c) {
        return c === 41 ? f(c) : br(e, l, a, "resourceDestination", "resourceDestinationLiteral", "resourceDestinationLiteralMarker", "resourceDestinationRaw", "resourceDestinationString", 32)(c)
    }

    function l(c) {
        return V(c) ? qe(e, u)(c) : f(c)
    }
    ...
    function u(c) {
        return c === 34 || c === 39 || c === 40 ? Sr(e, s, n, "resourceTitle", "resourceTitleMarker", "resourceTitleString")(c) : f(c)
    }

    function s(c) {
        return V(c) ? qe(e, f)(c) : f(c)
    }
...
function po(e, t, n) {
    ...
    function i(a) {
        return wr.call(r, e, o, l, "reference", "referenceMarker", "referenceString")(a)
    }
...
function wo(e, t, n) {
    ...
    function a(s) {
        return s === i ? (e.enter("thematicBreakSequence"), u(s)) : r >= 3 && (s === null || D(s)) ? (e.exit("thematicBreak"), t(s)) : n(s)
    }

    function u(s) {
        return s === i ? (e.consume(s), r++, u) : (e.exit("thematicBreakSequence"), N(s) ? j(e, a, "whitespace")(s) : a(s))
    }
}
const Z = {
        continuation: {
...
function Eo(e, t, n) {
    ...
    function a(h) {
        ...
        if (d === "listUnordered" ? !r.containerState.marker || h === r.containerState.marker : Rn(h)) {
            if (r.containerState.type || (r.containerState.type = d, e.enter(d, {
                    _container: !0
                })), d === "listUnordered") return e.enter("listItemPrefix"), h === 42 || h === 45 ? e.check(nn, n, s)(h) : s(h);
    ...
    function s(h) {
        return e.enter("listItemMarker"), e.consume(h), e.exit("listItemMarker"), r.containerState.marker = r.containerState.marker || h, e.check(Xe, r.interrupt ? n : f, e.attempt(So, p, c))
    }
    ...
    function c(h) {
        return N(h) ? (e.enter("listItemPrefixWhitespace"), e.consume(h), e.exit("listItemPrefixWhitespace"), p) : n(h)
    }
...
function Io(e, t, n) {
    const r = this;
    return r.containerState._closeFlow = void 0, e.check(Xe, i, o);
    ...
    function o(a) {
        return r.containerState.furtherBlankLines || !N(a) ? (r.containerState.furtherBlankLines = void 0, r.containerState.initialBlankLine = void 0, l(a)) : (r.containerState.furtherBlankLines = void 0, r.containerState.initialBlankLine = void 0, e.attempt(Co, t, l)(a))
    }
...
function vo(e, t) {
    ...
    return e[i][1].type = "setextHeadingText", o ? (e.splice(i, 0, ["enter", l, t]), e.splice(o + 1, 0, ["exit", e[r][1], t]), e[r][1].end = { ...e[o][1].end
...
function zo(e, t, n) {
    ...
    function a(s) {
        return s === i ? (e.consume(s), a) : (e.exit("setextHeadingLineSequence"), N(s) ? j(e, u, "lineSuffix")(s) : u(s))
    }
...
function Lo(e) {
    const t = this,
        n = e.attempt(Xe, r, e.attempt(this.parser.constructs.flowInitial, i, j(e, e.attempt(this.parser.constructs.flow, i, e.attempt(Ol, i)), "linePrefix")));
    return n;
...
function Cr(e) {
    return {
        resolveAll: Er(e === "text" ? Oo : void 0),
        tokenize: t
    };
...
function Yo(e, t, n) {
    ...
    function E() {
        ...
        for (; r._index < l.length;) {
            const v = l[r._index];
            if (typeof v == "string")
                for (P = r._index, r._bufferIndex < 0 && (r._bufferIndex = 0); r._index === P && r._bufferIndex < v.length;) y(v.charCodeAt(r._bufferIndex));
            else y(v)
        }
    }
    ...
    function I(P) {
        D(P) ? (r.line++, r.column = 1, r.offset += P === -3 ? 2 : 1, k()) : P !== -1 && (r.column++, r.offset++), r._bufferIndex < 0 ? r._index++ : (r._bufferIndex++, r._bufferIndex === l[r._index].length && (r._bufferIndex = -1, r._index++)), s.previous = P
    }

    function C(P, v) {
        const z = v || {};
        return z.type = P, z.start = d(), s.events.push(["enter", z, s]), a.push(z), z
    }

    function R(P) {
        const v = a.pop();
        return v.end = d(), s.events.push(["exit", v, s]), v
    }
    ...
    function M(P, v) {
        ...
        function z(T, L, Y) {
            let X, le, he, m;
            return Array.isArray(T) ? pe(T) : "tokenize" in T ? pe([T]) : oe(T);

            function oe(Q) {
                return _e;

                function _e(ye) {
                    const Ie = ye !== null && Q[ye],
                        Ae = ye !== null && Q.null,
                        Ge = [...Array.isArray(Ie) ? Ie : Ie ? [Ie] : [], ...Array.isArray(Ae) ? Ae : Ae ? [Ae] : []];
                    return pe(Ge)(ye)
                }
            }

            function pe(Q) {
                return X = Q, le = 0, Q.length === 0 ? Y : g(Q[le])
            }
            ...
            function g(Q) {
                ...
                function _e(ye) {
                    return m = H(), he = Q, Q.partial || (s.currentConstruct = Q), Q.name && s.parser.constructs.disable.null.includes(Q.name) ? be() : Q.tokenize.call(v ? Object.assign(Object.create(s), v) : s, u, ae, be)(ye)
                }
            }
            ...
            function be(Q) {
                return m.restore(), ++le < X.length ? g(X[le]) : Y
            }
        }
    }

    function U(P, v) {
        P.resolveAll && !o.includes(P) && o.push(P), P.resolve && re(s.events, v, s.events.length - v, P.resolve(s.events.slice(v), s)), P.resolveTo && (s.events = P.resolveTo(s.events, s))
    }

    function H() {
        const P = d(),
            v = s.previous,
            z = s.currentConstruct,
            T = s.events.length,
            L = Array.from(a);
        return {
            from: T,
        ...
        function Y() {
            r = P, s.previous = v, s.currentConstruct = z, s.events.length = T, a = L, k()
        }
    }
...
function Jo() {
    ...
    function i(o, l, a) {
        ...
        for (o = t + (typeof o == "string" ? o.toString() : new TextDecoder(l || void 0).decode(o)), c = 0, t = "", n && (o.charCodeAt(0) === 65279 && c++, n = void 0); c < o.length;) {
            if (vt.lastIndex = c, s = vt.exec(o), p = s && s.index !== void 0 ? s.index : o.length, h = o.charCodeAt(p), !s) {
                t = o.slice(c);
                break
            }
            if (h === 10 && c === p && r) u.push(-3), r = void 0;
            else switch (r && (u.push(-5), r = void 0), c < p && (u.push(o.slice(c, p)), e += p - c), h) {
                case 0:
                    {
                        u.push(65533),
                        e++;
...
function na(e, t, n) {
    ...
    if (n.charCodeAt(0) === 35) {
        const i = n.charCodeAt(1),
            o = i === 120 || i === 88;
        return gr(n.slice(o ? 2 : 1), o ? 16 : 10)
    }
    return Xn(n) || e
}
...
function ta(e, t, n) {
    return typeof t != "string" && (n = t, t = void 0), ra(n)(Ko(Go(n).document().write(Jo()(e, t, !0))))
}
...
function ra(e) {
    ...
    function r(b) {
        ...
        for (q = -1; ++q < b.length;) {
            const ue = t[b[q][0]];
            Ir.call(ue, b[q][1].type) && ue[b[q][1].type].call(Object.assign({
                sliceSerialize: b[q][2].sliceSerialize
            }, F), b[q][1])
        }
        if (F.tokenStack.length > 0) {
            const ue = F.tokenStack[F.tokenStack.length - 1];
            (ue[1] || zt).call(F, void 0, ue[0])
        }
        for (A.position = {
            ...
            }, q = -1; ++q < t.transforms.length;) A = t.transforms[q](A) || A;
        return A
    }
        ...
        for (; ++B <= F;) {
            ...
            switch (ne[1].type) {
                ...
                case "lineEndingBlank":
                    {
                        ne[0] === "enter" && (we && !Me && !q && !Oe && (Oe = B), Me = void 0);
                        break
                    }
                case "linePrefix":
                case "listItemValue":
            ...
            if (!q && ne[0] === "enter" && ne[1].type === "listItemPrefix" || q === -1 && ne[0] === "exit" && (ne[1].type === "listUnordered" || ne[1].type === "listOrdered")) {
                if (we) {
                    ...
                    for (me = void 0; Te--;) {
                        ...
                        if (ge[1].type === "lineEnding" || ge[1].type === "lineEndingBlank") {
                            ...
                            me && (b[me][1].type = "lineEndingBlank", ue = !0), ge[1].type = "lineEnding", me = Te
                    ...
                    Oe && (!me || Oe < me) && (we._spread = !0), we.end = Object.assign({}, me ? b[me][1].start : ne[1].end), b.splice(me || B, 0, ["exit", we, ne[2]]), B++, F++
                }
                if (ne[1].type === "listItemPrefix") {
                    ...
                    we = Te, b.splice(B, 0, ["enter", Te, ne[2]]), B++, F++, Oe = void 0, Me = !0
                }
            }
        }
        return b[A][1]._spread = ue, F
    }
    ...
    function a(b, A, F) {
        this.stack[this.stack.length - 1].children.push(b), this.stack.push(b), this.tokenStack.push([A, F || void 0]), b.position = {
            start: ke(A.start),
            end: void 0
        }
    }
    ...
    function s(b, A) {
        const F = this.stack.pop(),
            B = this.tokenStack.pop();
        if (B) B[0].type !== b.type && (A ? A.call(this, b, B[0]) : (B[1] || zt).call(this, b, B[0]));
        else throw new Error("Cannot close `" + b.type + "` (" + Ue({
            start: b.start,
            end: b.end
        }) + "): it’s not open");
    ...
    function I(b) {
        ...
        F.label = A, F.identifier = se(this.sliceSerialize(b)).toLowerCase()
    }
    ...
    function le(b) {
        ...
        F.label = ea(A), F.identifier = se(A).toLowerCase()
    }
    ...
    function ae(b) {
        const A = this.resume(),
            F = this.stack[this.stack.length - 1];
        F.label = A, F.identifier = se(this.sliceSerialize(b)).toLowerCase(), this.data.referenceType = "full"
    }
    ...
    function Q(b) {
        ...
        let B;
        F ? (B = gr(A, F === "characterReferenceMarkerNumeric" ? 10 : 16), this.data.characterReferenceType = void 0) : B = Xn(A);
...
function zt(e, t) {
    ...
    }) + ") is open") : new Error("Cannot close document, a token (`" + t.type + "`, " + Ue({
        start: t.start,
        end: t.end
    }) + ") is still open")
}
...
function Ia(e, t) {
    ...
    if (n.length > 0) {
        const l = {
            ...
            a = qn(t.children[1]),
            u = ar(t.children[t.children.length - 1]);
        a && u && (l.position = {
            start: a,
            end: u
        }), i.push(l)
...
function Pa(e) {
    ...
    let r = n.exec(t),
        i = 0;
    const o = [];
    for (; r;) o.push(Ft(t.slice(i, r.index), i > 0, !0), r[0]), i = r.index + r[0].length, r = n.exec(t);
    return o.push(Ft(t.slice(i), i > 0, !1)), o.join("")
}
...
function Ft(e, t, n) {
    ...
    if (t) {
        ...
        for (; o === Dt || o === Lt;) r++, o = e.codePointAt(r)
    }
    if (n) {
        let o = e.codePointAt(i - 1);
        for (; o === Dt || o === Lt;) i--, o = e.codePointAt(i - 1)
    }
...
const vr = -1,
    ...
    zr = 7,
    Dr = 8,
    Rt = typeof self == "object" ? self : globalThis,
    La = (e, t) => {
    ...
    He = e => {
        const t = typeof e;
        if (t !== "object" || !e) return [sn, t];
        const n = Fa.call(e).slice(8, -1);
        switch (n) {
            case "Array":
                return [Ve, ve];
            case "Object":
        ...
        return n.includes("Array") ? [Ve, n] : n.includes("Error") ? [zr, n] : [rn, n]
    },
    Je = ([e, t]) => e === sn && (t === "function" || t === "symbol"),
    _a = (e, t, n, r) => {
        const i = (l, a) => {
                const u = r.push(l) - 1;
                return n.set(a, u), u
                    ...
                    case rn:
                        {
                            ...
                            const f = [],
                                c = i([a, f], l);
                            for (const p of Ra(l))(e || !Je(He(l[p]))) && f.push([o(p), o(l[p])]);
                            return c
                        }
                    case Gn:
                    ...
                    case Jn:
                        {
                            const f = [],
                                c = i([a, f], l);
                            for (const [p, h] of l)(e || !(Je(He(p)) || Je(He(h)))) && f.push([o(p), o(h)]);
                            return c
                        }
                    case Zn:
                        {
                            const f = [],
                                c = i([a, f], l);
                            for (const p of l)(e || !Je(He(p))) && f.push(o(p));
                            return c
                        }
                }
                const {
    ...
    Ot = (e, {
        ...
        const r = [];
        return _a(!(t || n), !!t, new Map, r)(e), r
    },
    ln = typeof structuredClone == "function" ? (e, t) => t && ("json" in t || "lossy" in t) ? _t(Ot(e, t)) : structuredClone(e) : (e, t) => _t(Ot(e, t));
...
function Na(e) {
    const t = typeof e.options.clobberPrefix == "string" ? e.options.clobberPrefix : "user-content-",
        n = e.options.footnoteBackContent || Oa,
        r = e.options.footnoteBackLabel || Ma,
    ...
    for (; ++u < e.footnoteOrder.length;) {
        ...
        if (!s) continue;
        const f = e.all(s),
            c = String(s.identifier).toUpperCase(),
            p = Re(c.toLowerCase());
        let h = 0;
        const d = [],
            x = e.footnoteCounts.get(c);
        for (; x !== void 0 && ++h <= x;) {
            d.length > 0 && d.push({
                type: "text",
                value: " "
        ...
        if (E && E.type === "element" && E.tagName === "p") {
            ...
            I && I.type === "text" ? I.value += " " : E.children.push({
                type: "text",
                value: " "
            }), E.children.push(...d)
        } else f.push(...d);
...
const cn = (function(e) {
    if (e == null) return Ua;
    if (typeof e == "function") return fn(e);
    if (typeof e == "object") return Array.isArray(e) ? Ba(e) : ja(e);
...
function fn(e) {
    ...
    function t(n, r, i) {
        return !!(qa(n) && e.call(this, n, typeof r == "number" ? r : void 0, i || void 0))
    }
}
...
function Wa(e) {
    return Array.isArray(e) ? e : typeof e == "number" ? [Va, e] : e == null ? Lr : [e]
}

function et(e, t, n, r) {
    let i, o, l;
    typeof t == "function" && typeof n != "function" ? (o = void 0, l = t, i = n) : (o = t, l = n, i = r), Fr(e, o, a, i);

    function a(u, s) {
        const f = s[s.length - 1],
            c = f ? f.children.indexOf(u) : void 0;
        return l(u, c, f)
    }
}
...
function Xa(e, t) {
    ...
    function u(f, c) {
        const p = f.type,
            h = a.handlers[p];
        if (Mn.call(a.handlers, p) && h) return h(a, f, c);
        ...
        return (a.options.unknownHandler || Ka)(a, f, c)
    }
    ...
    function s(f) {
        ...
        if ("children" in f) {
            ...
            for (; ++h < p.length;) {
                const d = a.one(p[h], f);
                if (d) {
                    if (h && p[h - 1].type === "break" && (!Array.isArray(d) && d.type === "text" && (d.value = Mt(d.value)), !Array.isArray(d) && d.type === "element")) {
...
function Ka(e, t) {
    const n = t.data || {},
        r = "value" in t && !(Mn.call(n, "hProperties") || Mn.call(n, "hChildren")) ? {
            type: "text",
            value: t.value
        } : {
            type: "element",
...
function eu() {
    ...
    var e = Object.prototype.hasOwnProperty,
        ...
        o = function(s) {
            ...
            var f = e.call(s, "constructor"),
                c = s.constructor && s.constructor.prototype && e.call(s.constructor.prototype, "isPrototypeOf");
    ...
    return kn = function u() {
        var s, f, c, p, h, d, x = arguments[0],
            E = 1,
            y = arguments.length,
            I = !1;
        for (typeof x == "boolean" && (I = x, x = arguments[1] || {}, E = 2), (x == null || typeof x != "object" && typeof x != "function") && (x = {}); E < y; ++E)
            if (s = arguments[E], s != null)
                for (f in s) c = a(x, f), p = a(s, f), x !== p && (I && p && (o(p) || (h = i(p))) ? (h ? (h = !1, d = c && i(c) ? c : []) : d = c && o(c) ? c : {}, l(x, {
                    name: f,
                    newValue: u(I, d, p)
                })) : typeof p < "u" && l(x, {
                    name: f,
...
function au(...e) {
    let t = -1,
        n;
    for (; ++t < e.length;) Qe(e[t]), e[t] && (n = n === void 0 ? e[t] : n + "/" + e[t]);
...
const bn = ["history", "path", "basename", "stem", "extname", "dirname"];
class Rr {
    constructor(t) {
        let n;
        t ? Bn(t) ? n = {
            path: t
        } : typeof t == "string" || mu(t) ? n = {
            value: t
        } : n = t : n = {}, this.cwd = "cwd" in n ? "" : cu.cwd(), this.data = {}, this.history = [], this.messages = [], this.value, this.map, this.result, this.stored;
        let r = -1;
        for (; ++r < bn.length;) {
            const o = bn[r];
        ...
        let i;
        for (i in n) bn.includes(i) || (this[i] = n[i])
    }
    get basename() {
        return typeof this.path == "string" ? ce.basename(this.path) : void 0
    }
    set basename(t) {
        Sn(t, "basename"), wn(t, "basename"), this.path = ce.join(this.dirname || "", t)
    }
    get dirname() {
        return typeof this.path == "string" ? ce.dirname(this.path) : void 0
    }
    set dirname(t) {
        Ht(this.basename, "dirname"), this.path = ce.join(t || "", this.basename)
    }
    get extname() {
        return typeof this.path == "string" ? ce.extname(this.path) : void 0
    }
    set extname(t) {
        if (wn(t, "extname"), Ht(this.dirname, "extname"), t) {
    ...
    set path(t) {
        Bn(t) && (t = hu(t)), Sn(t, "path"), this.path !== t && this.history.push(t)
    }
    get stem() {
        return typeof this.path == "string" ? ce.basename(this.path, this.extname) : void 0
    }
    set stem(t) {
        Sn(t, "stem"), wn(t, "stem"), this.path = ce.join(this.dirname || "", t + (this.extname || ""))
    }
    fail(t, n, r) {
...
function wn(e, t) {
    if (e && e.includes(ce.sep)) throw new Error("`" + t + "` cannot be a path: did not expect `" + ce.sep + "`")
}
...
class nt extends gu {
    ...
    data(t, n) {
        return typeof t == "string" ? arguments.length === 2 ? (In("data", this.frozen), this.namespace[t] = n, this) : du.call(this.namespace, t) && this.namespace[t] || void 0 : t ? (In("data", this.frozen), this.namespace = t, this) : this.namespace
    }
    freeze() {
    ...
    process(t, n) {
        const r = this;
        return this.freeze(), Cn("process", this.parser || this.Parser), En("process", this.compiler || this.Compiler), n ? i(void 0, n) : new Promise(i);
    ...
    stringify(t, n) {
        ...
        return En("stringify", i), Ut(t), i(t, r)
    }
    use(t, ...n) {
        const r = this.attachers,
            i = this.namespace;
        if (In("use", this.frozen), t != null)
        ...
        function u(s, f) {
            ...
            if (p === -1) r.push([s, ...f]);
                ...
                let [h, ...d] = f;
                const x = r[p][1];
                Nn(x) && Nn(h) && (h = xn(!0, x, h)), r[p] = [s, h, ...d]
            }
        }
    }
}
const yu = new nt().freeze();
...
const wu = "https://github.com/remarkjs/react-markdown/blob/main/changelog.md",
    Vt = [],
    $t = {
...
function Nc(e) {
    const t = Eu(e),
        n = Iu(e);
    return Au(t.runSync(t.parse(n), n), e)
}

function Eu(e) {
    const t = e.rehypePlugins || Vt,
        n = e.remarkPlugins || Vt,
        r = e.remarkRehypeOptions ? { ...e.remarkRehypeOptions,
            ...$t
        } : $t;
    return yu().use(la).use(n).use(Za, r).use(t)
}
...
function Au(e, t) {
    const n = t.allowedElements,
        ...
        u = t.urlTransform || Tu;
    for (const f of Cu) Object.hasOwn(t, f.from) && ("" + f.from + (f.to ? "use `" + f.to + "` instead" : "remove it") + wu + f.id, void 0);
    ...
    function s(f, c, p) {
        if (f.type === "raw" && p && typeof c == "number") return l ? p.children.splice(c, 1) : p.children[c] = {
            type: "text",
            value: f.value
        }, c;
        if (f.type === "element") {
...
function Tu(e) {
    const t = e.indexOf(":"),
        ...
        r = e.indexOf("#"),
        i = e.indexOf("/");
    return t === -1 || i !== -1 && t > i || n !== -1 && t > n || r !== -1 && t > r || Su.test(e.slice(0, t)) ? e : ""
}
    ...
    function u(s, f) {
        ...
        for (; C;) {
            ...
            if (typeof w == "string" && (w = w.length > 0 ? {
                    type: "text",
                    value: w
                } : void 0), w === !1 ? p.lastIndex = R + 1 : (d !== R && I.push({
                    type: "text",
                    value: s.value.slice(d, R)
                }), Array.isArray(w) ? I.push(...w) : w && I.push(w), d = R + C[0].length, y = !0), !p.global) break;
            C = p.exec(s.value)
        }
        return y ? (d < s.value.length && I.push({
            type: "text",
            value: s.value.slice(d)
        }), c.children.splice(E, 1, ...I)) : I = [s], E + I.length
    }
}
...
function zu(e) {
    ...
    for (; ++r < n.length;) {
        const i = n[r];
        t.push([Du(i[0]), Lu(i[1])])
    }
    return t
}

function Du(e) {
    return typeof e == "string" ? new RegExp(Pu(e), "g") : e
}
...
function Fu() {
    return {
        ...
        exit: {
            literalAutolink: Bu,
            literalAutolinkEmail: Nu,
            literalAutolinkHttp: Ou,
            literalAutolinkWww: Mu
        }
    }
}
...
function Hu(e, t, n, r, i) {
    let o = "";
    if (!_r(i) || (/^w/i.test(t) && (n = t + n, t = "", o = "http://"), !qu(n))) return !1;
    const l = Vu(n + r);
    if (!l[0]) return !1;
    const a = {
        type: "link",
...
function _r(e, t) {
    ...
    return (e.index === 0 || Ce(n) || an(n)) && (!t || n !== 47)
}
Or.peek = Zu;
...
function es() {
    return {
        enter: {
            ...
            gfmFootnoteDefinition: Xu
        },
        exit: {
            gfmFootnoteCallString: Qu,
            gfmFootnoteCall: Gu,
...
` : " ") + o.indentLines(o.containerFlow(r, a.current()), t ? Mr : ts))), s(), u
    }
}

function ts(e, t, n) {
    return t === 0 ? e : Mr(e, t, n)
}
...
function Nr(e, t, n, r) {
    ...
    let l = i.move("~~");
    return l += n.containerPhrasing(e, { ...i.current(),
        before: l,
        after: "~"
    }), l += i.move("~~"), o(), l
}
...
function cs(e, t) {
    ...
    for (; ++c < s;) {
        ...
        let E = "",
            y = "";
        x === 99 ? (E = ":", y = ":") : x === 108 ? E = ":" : x === 114 && (y = ":");
        let I = n.alignDelimiters === !1 ? 1 : Math.max(1, u[c] - E.length - y.length);
        const C = E + "-".repeat(I) + y;
        n.alignDelimiters !== !1 && (I = E.length + I + y.length, I > u[c] && (u[c] = I), h[c] = I), p[c] = C
    }
    ...
    for (; ++f < l.length;) {
        ...
        for (; ++c < s;) {
            ...
            if (n.alignDelimiters !== !1) {
                const _ = u[c] - (E[c] || 0),
                    w = o[c];
                w === 114 ? C = " ".repeat(_) : w === 99 ? _ % 2 ? (C = " ".repeat(_ / 2 + .5), R = " ".repeat(_ / 2 - .5)) : (C = " ".repeat(_ / 2), R = C) : R = " ".repeat(_)
            }
            n.delimiterStart !== !1 && !c && y.push("|"), n.padding !== !1 && !(n.alignDelimiters === !1 && I === "") && (n.delimiterStart !== !1 || c) && y.push(" "), n.alignDelimiters !== !1 && y.push(C), y.push(I), n.alignDelimiters !== !1 && y.push(R), n.padding !== !1 && y.push(" "), (n.delimiterEnd !== !1 || c !== s - 1) && y.push("|")
        }
        d.push(n.delimiterEnd === !1 ? y.join("").replace(/ +$/, "") : y.join(""))
    }
    return d.join(`
`)
}
...
function hs(e, t, n, r) {
    const i = n.enter("blockquote"),
        o = n.createTracker(r);
    o.move("> "), o.shift(2);
    const l = n.indentLines(n.containerFlow(e, o.current()), ps);
    return i(), l
}
...
function ms(e, t) {
    return Xt(e, t.inConstruct, !0) && !Xt(e, t.notInConstruct, !1)
}
...
` && ms(n.stack, n.unsafe[i])) return /[ \t]/.test(r.before) ? "" : " ";
    return `\\
`
}
...
function ks(e, t, n, r) {
    ...
    if (ds(e, n)) {
        const c = n.enter("codeIndented"),
            p = n.indentLines(o, xs);
        return c(), p
    }
    const a = n.createTracker(r),
        u = i.repeat(Math.max(gs(o, i) + 1, 3)),
...
function Br(e, t, n, r) {
    ...
    const s = u.charCodeAt(0),
        f = on(r.before.charCodeAt(r.before.length - 1), s, i);
    f.inside && (u = We(s) + u.slice(1));
    const c = u.charCodeAt(u.length - 1),
        p = on(r.after.charCodeAt(0), c, i);
    p.inside && (u = u.slice(0, -1) + We(c));
    const h = l.move(i);
...
function Cs(e, t) {
    ...
    return et(e, function(r) {
        if ("value" in r && /\r?\n|\r/.test(r.value) || r.type === "break") return n = !0, On
...
function Es(e, t, n, r) {
    ...
    if (Cs(e, n)) {
        const f = n.enter("headingSetext"),
            c = n.enter("phrasing"),
            p = n.containerPhrasing(e, { ...o.current(),
                before: `
`,
                after: `
`
...
`,
    ...
    return /^[\t ]/.test(s) && (s = We(s.charCodeAt(0)) + s.slice(1)), s = s ? l + " " + s : l, n.options.closeAtx && (s += " " + l), u(), a(), s
}
jr.peek = Is;
...
function Fs(e, t, n, r) {
    const i = n.enter("list"),
        o = n.bulletCurrent;
    let l = e.ordered ? Ls(n) : rt(n);
    const a = e.ordered ? l === "." ? ")" : "." : Ds(n);
    let u = t && n.bulletLastUsed ? l === n.bulletLastUsed : !1;
    if (!e.ordered) {
        const f = e.children ? e.children[0] : void 0;
        if ((l === "*" || l === "-") && f && (!f.children || !f.children[0]) && n.stack[n.stack.length - 1] === "list" && n.stack[n.stack.length - 2] === "listItem" && n.stack[n.stack.length - 3] === "list" && n.stack[n.stack.length - 4] === "listItem" && n.indexStack[n.indexStack.length - 1] === 0 && n.indexStack[n.indexStack.length - 2] === 0 && n.indexStack[n.indexStack.length - 3] === 0 && (u = !0), Yr(n) === l && f) {
            let c = -1;
...
function _s(e, t, n, r) {
    ...
    const u = n.enter("listItem"),
        s = n.indentLines(n.containerFlow(e, a.current()), f);
    return u(), s;
...
const Ms = cn(["break", "delete", "emphasis", "footnote", "footnoteReference", "image", "imageReference", "inlineCode", "inlineMath", "link", "linkReference", "mdxJsxTextElement", "mdxTextExpression", "strong", "text", "textDirective"]);
...
function qs(e, t, n) {
    const r = (Yr(n) + (n.options.ruleSpaces ? " " : "")).repeat(Us(n));
...
function Xs(e) {
    let t = this.resume();
    this.data.inTable && (t = t.replace(/\\([\\|])/g, Qs));
...
`))
    ...
    function u(h, d, x, E) {
        const y = x.enter("tableCell"),
            I = x.enter("phrasing"),
            C = x.containerPhrasing(h, { ...E,
                before: o,
                after: o
            });
        return I(), y(), C
    ...
    function c(h, d, x) {
        ...
        const I = [],
            C = d.enter("tableRow");
        for (; ++y < E.length;) I[y] = u(E[y], h, d, x);
        return C(), I
    }

    function p(h, d, x) {
        let E = Qr.inlineCode(h, d, x);
...
function nc() {
    return [Fu(), es(), is(), Vs(), Ks()]
}

function tc(e) {
    return {
        extensions: [Ru(), ns(e), ls(), Gs(e), Js()]
    }
}
const rc = {
        tokenize: sc,
...
let Se = 48;
for (; Se < 123;) fe[Se] = de, Se++, Se === 58 ? Se = 65 : Se === 91 && (Se = 97);
fe[43] = de;
fe[45] = de;
fe[46] = de;
fe[95] = de;
...
function oc(e, t, n) {
    ...
    function l(c) {
        return !jn(c) || !ri.call(r, r.previous) || it(r.events) ? n(c) : (e.enter("literalAutolink"), e.enter("literalAutolinkEmail"), a(c))
    }
    ...
    function u(c) {
        return c === 46 ? e.check(ic, f, s)(c) : c === 45 || c === 95 || G(c) ? (o = !0, e.consume(c), u) : f(c)
    }
...
function ac(e, t, n) {
    ...
    function i(l) {
        return l !== 87 && l !== 119 || !ni.call(r, r.previous) || it(r.events) ? n(l) : (e.enter("literalAutolink"), e.enter("literalAutolinkWww"), e.check(rc, e.attempt(Gr, e.attempt(Kr, o), n), n)(l))
    }
...
function uc(e, t, n) {
    ...
    function l(c) {
        return (c === 72 || c === 104) && ti.call(r, r.previous) && !it(r.events) ? (e.enter("literalAutolink"), e.enter("literalAutolinkHttp"), i += String.fromCodePoint(c), e.consume(c), a) : n(c)
    }

    function a(c) {
        if (J(c) && i.length < 5) return i += String.fromCodePoint(c), e.consume(c), a;
        if (c === 58) {
            const p = i.toLowerCase();
            if (p === "http" || p === "https") return e.consume(c), u
        }
        return n(c)
    }
    ...
    function s(c) {
        return c === null || tn(c) || V(c) || Ce(c) || an(c) ? n(c) : e.attempt(Gr, e.attempt(Kr, f), n)(c)
    }
...
function cc(e, t, n) {
    ...
    function l(s) {
        return s === 46 || s === 95 ? e.check(Jr, u, a)(s) : s === null || V(s) || Ce(s) || s !== 45 && an(s) ? u(s) : (o = !0, e.consume(s), l)
    }
...
function fc(e, t) {
    ...
    function i(l) {
        return l === 40 ? (n++, e.consume(l), i) : l === 41 && r < n ? o(l) : l === 33 || l === 34 || l === 38 || l === 39 || l === 41 || l === 42 || l === 44 || l === 46 || l === 58 || l === 59 || l === 60 || l === 63 || l === 93 || l === 95 || l === 126 ? e.check(Jr, t, o)(l) : l === null || V(l) || Ce(l) ? t(l) : (e.consume(l), i)
    }
...
function hc(e, t, n) {
    ...
    function r(a) {
        return a === 33 || a === 34 || a === 39 || a === 41 || a === 42 || a === 44 || a === 46 || a === 58 || a === 59 || a === 63 || a === 95 || a === 126 ? (e.consume(a), r) : a === 38 ? (e.consume(a), o) : a === 93 ? (e.consume(a), i) : a === 60 || a === null || V(a) || Ce(a) ? t(a) : n(a)
    }
...
function kc(e, t, n) {
    ...
    function s(c) {
        if (o > 999 || c === 93 && !l || c === null || c === 91 || V(c)) return n(c);
        if (c === 93) {
            e.exit("chunkString");
...
function xc(e, t, n) {
    ...
    function f(d) {
        if (l > 999 || d === 93 && !a || d === null || d === 91 || V(d)) return n(d);
        if (d === 93) {
            e.exit("chunkString");
    ...
    function p(d) {
        return d === 58 ? (e.enter("definitionMarker"), e.consume(d), e.exit("definitionMarker"), i.includes(o) || i.push(o), j(e, h, "gfmFootnoteDefinitionWhitespace")) : n(d)
    }
...
function bc(e, t, n) {
    return e.check(Xe, t, e.attempt(mc, t, n))
}
...
function Cc(e) {
            ...
            if (l[u][0] === "enter" && l[u][1].type === "strikethroughSequenceTemporary" && l[u][1]._close) {
                ...
                for (; s--;)
                    if (l[s][0] === "exit" && l[s][1].type === "strikethroughSequenceTemporary" && l[s][1]._open && l[u][1].end.offset - l[u][1].start.offset === l[s][1].end.offset - l[s][1].start.offset) {
                        ...
                        h && re(p, p.length, 0, un(h, l.slice(s + 1, u), a)), re(p, p.length, 0, [
                            ["exit", c, a],
                            ["enter", l[u][1], a],
                            ["exit", l[u][1], a],
                            ["exit", f, a]
    ...
    function o(l, a, u) {
        ...
        function h(d) {
            const x = Le(s);
            if (d === 126) return c > 1 ? u(d) : (l.consume(d), c++, h);
            if (c < 2 && !n) return u(d);
            const E = l.exit("strikethroughSequenceTemporary"),
                y = Le(d);
            return E._open = !y || y === 2 && !!x, E._close = !x || x === 2 && !!y, a(d)
        }
    }
}
class Ec {
...
function Pc(e, t, n) {
    ...
    function a(k) {
        ...
        for (; P > -1;) {
            ...
            if (T === "lineEnding" || T === "linePrefix") P--;
            else break
        }
        const v = P > -1 ? r.events[P][1].type : null,
            z = v === "tableHead" || v === "tableRow" ? w : u;
        return z === w && r.parser.lazy[r.now().line] ? n(k) : z(k)
    }
    ...
    function h(k) {
        return r.interrupt = !1, r.parser.lazy[r.now().line] ? n(k) : (e.enter("tableDelimiterRow"), l = !1, N(k) ? j(e, d, "linePrefix", r.parser.constructs.disable.null.includes("codeIndented") ? void 0 : 4)(k) : d(k))
    }

    function d(k) {
        return k === 45 || k === 58 ? E(k) : k === 124 ? (l = !0, e.enter("tableCellDivider"), e.consume(k), e.exit("tableCellDivider"), x) : _(k)
    }

    function x(k) {
        return N(k) ? j(e, E, "whitespace")(k) : E(k)
    }

    function E(k) {
        return k === 58 ? (o += 1, l = !0, e.enter("tableDelimiterMarker"), e.consume(k), e.exit("tableDelimiterMarker"), y) : k === 45 ? (o += 1, y(k)) : k === null || D(k) ? R(k) : _(k)
    }
    ...
    function I(k) {
        return k === 45 ? (e.consume(k), I) : k === 58 ? (l = !0, e.exit("tableDelimiterFiller"), e.enter("tableDelimiterMarker"), e.consume(k), e.exit("tableDelimiterMarker"), C) : (e.exit("tableDelimiterFiller"), C(k))
    }

    function C(k) {
        return N(k) ? j(e, R, "whitespace")(k) : R(k)
    }

    function R(k) {
        return k === 124 ? d(k) : k === null || D(k) ? !l || i !== o ? _(k) : (e.exit("tableDelimiterRow"), e.exit("tableHead"), t(k)) : _(k)
    }
    ...
    function M(k) {
        return k === 124 ? (e.enter("tableCellDivider"), e.consume(k), e.exit("tableCellDivider"), M) : k === null || D(k) ? (e.exit("tableRow"), t(k)) : N(k) ? j(e, M, "whitespace")(k) : (e.enter("data"), U(k))
    }

    function U(k) {
        return k === null || k === 124 || V(k) ? (e.exit("data"), M(k)) : (e.consume(k), k === 92 ? H : U)
    }
...
function vc(e, t) {
    ...
    for (; ++n < e.length;) {
        const h = e[n],
            d = h[1];
        h[0] === "enter" ? d.type === "tableHead" ? (a = !1, u !== 0 && (Jt(p, t, u, s, f), f = void 0, u = 0), s = {
            type: "table",
            start: Object.assign({}, d.start),
            end: Object.assign({}, d.end)
        }, p.add(n, 0, [
            ["enter", s, t]
        ])) : d.type === "tableRow" || d.type === "tableDelimiterRow" ? (r = !0, c = void 0, o = [0, 0, 0, 0], l = [0, n + 1, 0, 0], a && (a = !1, f = {
            type: "tableBody",
            start: Object.assign({}, d.start),
            end: Object.assign({}, d.end)
        }, p.add(n, 0, [
            ["enter", f, t]
        ])), i = d.type === "tableDelimiterRow" ? 2 : f ? 3 : 1) : i && (d.type === "data" || d.type === "tableDelimiterMarker" || d.type === "tableDelimiterFiller") ? (r = !1, l[2] === 0 && (o[1] !== 0 && (l[0] = l[1], c = en(p, t, o, i, void 0, c), o = [0, 0, 0, 0]), l[2] = n)) : d.type === "tableCellDivider" && (r ? r = !1 : (o[1] !== 0 && (l[0] = l[1], c = en(p, t, o, i, void 0, c)), o = l, l = [o[1], n, 0, 0])) : d.type === "tableHead" ? (a = !0, u = n) : d.type === "tableRow" || d.type === "tableDelimiterRow" ? (u = n, o[1] !== 0 ? (l[0] = l[1], c = en(p, t, o, i, n, c)) : l[1] !== 0 && (c = en(p, t, l, i, n, c)), i = 0) : i && (d.type === "data" || d.type === "tableDelimiterMarker" || d.type === "tableDelimiterFiller") && (l[3] = n)
    }
    for (u !== 0 && Jt(p, t, u, s, f), p.consume(t.events), n = -1; ++n < t.events.length;) {
        const h = t.events[n];
        h[0] === "enter" && h[1].type === "table" && (h[1]._align = Ac(t.events, n))
    }
    return e
}
...
function Bc(e) {
    ...
    i.push(Rc(n)), o.push(nc()), l.push(tc(n))
}
export {
    Nc as M, Bc as r
};